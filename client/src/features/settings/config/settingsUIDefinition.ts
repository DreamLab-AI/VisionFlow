...
const createGraphSettingsSubsections = (graphName: 'logseq' | 'visionflow') => ({
  ...
  [`${graphName}Physics`]: {
    ...
    settings: {
      ...
      attractionStrength: { label: 'Attraction Strength', type: 'slider', min: 0.001, max: 2.0, step: 0.001, path: `visualisation.graphs.${graphName}.physics.attractionStrength`, description: 'Force pulling connected nodes together.' },
      boundsSize: { label: 'Bounds Size', type: 'slider', min: 10, max: 1000, step: 10, unit: 'units', path: `visualisation.graphs.${graphName}.physics.boundsSize`, description: 'Simulation space boundaries.' },
      collisionRadius: { label: 'Collision Radius', type: 'slider', min: 0.5, max: 50, step: 0.5, unit: 'units', path: `visualisation.graphs.${graphName}.physics.collisionRadius`, description: 'Node collision detection distance.' },
      damping: { label: 'Damping', type: 'slider', min: 0.1, max: 0.99, step: 0.01, path: `visualisation.graphs.${graphName}.physics.damping`, description: 'Velocity reduction factor (higher = slower settling).' },
      ...
      repulsionStrength: { label: 'Repulsion Strength', type: 'slider', min: 1, max: 1000, step: 1, path: `visualisation.graphs.${graphName}.physics.repulsionStrength`, description: 'Force pushing unconnected nodes apart.' },
      springStrength: { label: 'Spring Strength', type: 'slider', min: 0.001, max: 5.0, step: 0.001, path: `visualisation.graphs.${graphName}.physics.springStrength`, description: 'Edge stiffness (higher = tighter connections).' },
      repulsionDistance: { label: 'Repulsion Distance', type: 'slider', min: 1, max: 500, step: 1, unit: 'units', path: `visualisation.graphs.${graphName}.physics.repulsionDistance`, description: 'Range of node repulsion effects.' },
