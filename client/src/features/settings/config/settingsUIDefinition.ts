...
const createGraphSettingsSubsections = (graphName: 'logseq' | 'visionflow') => ({
  ...
  [`${graphName}Physics`]: {
    ...
    settings: {
      ...
      attractionStrength: { label: 'Attraction Strength', type: 'slider', min: 0.001, max: 0.1, step: 0.001, path: `visualisation.graphs.${graphName}.physics.attractionStrength`, description: 'Force pulling connected nodes together.' },
