...
const createGraphSettingsSubsections = (graphName: 'logseq' | 'visionflow') => ({
  [`${graphName}Nodes`]: {
    label: `${graphName === 'logseq' ? 'Logseq Graph' : 'VisionFlow Graph'} - Nodes`,
    settings: {
      ...
      metalness: { label: 'Metalness', type: 'slider', min: 0, max: 1, step: 0.01, path: `visualisation.graphs.${graphName}.nodes.metalness`, description: 'Material metallic properties (0 = dielectric, 1 = metallic).' },
      opacity: { label: 'Opacity', type: 'slider', min: 0.1, max: 1, step: 0.01, path: `visualisation.graphs.${graphName}.nodes.opacity`, description: 'Node transparency (0.1-1.0 for visibility).' },
      roughness: { label: 'Roughness', type: 'slider', min: 0, max: 1, step: 0.01, path: `visualisation.graphs.${graphName}.nodes.roughness`, description: 'Surface roughness (0 = mirror, 1 = fully rough).' },
      nodeSize: { label: 'Node Size', type: 'slider', min: 0.1, max: 5.0, step: 0.05, path: `visualisation.graphs.${graphName}.nodes.nodeSize`, description: 'Overall node scale factor.' },
  ...
  [`${graphName}Edges`]: {
    label: `${graphName === 'logseq' ? 'Logseq Graph' : 'VisionFlow Graph'} - Connections`,
    settings: {
      arrowSize: { label: 'Arrow Size', type: 'slider', min: 0.01, max: 2.0, step: 0.01, path: `visualisation.graphs.${graphName}.edges.arrowSize`, description: 'Size of directional arrows on edges.' },
      baseWidth: { label: 'Base Width', type: 'slider', min: 0.01, max: 5.0, step: 0.01, path: `visualisation.graphs.${graphName}.edges.baseWidth`, description: 'Base thickness of edge lines.' },
      ...
      opacity: { label: 'Opacity', type: 'slider', min: 0.05, max: 1, step: 0.01, path: `visualisation.graphs.${graphName}.edges.opacity`, description: 'Edge transparency (0.05-1.0 for visibility).' },
      widthRange: { label: 'Width Range', type: 'rangeSlider', min: 0.01, max: 10.0, step: 0.01, path: `visualisation.graphs.${graphName}.edges.widthRange`, description: 'Min/max edge width based on connection weight.' },
      ...
      // Flow effects removed - not supported by backend EdgeSettings
    },
  },
  [`${graphName}Labels`]: {
    label: `${graphName === 'logseq' ? 'Logseq Graph' : 'VisionFlow Graph'} - Text Labels`,
    settings: {
      ...
      desktopFontSize: { label: 'Font Size', type: 'slider', min: 0.1, max: 3.0, step: 0.1, unit: 'em', path: `visualisation.graphs.${graphName}.labels.desktopFontSize`, description: 'Label text size in desktop mode.' },
      maxLabelWidth: { label: 'Max Label Width', type: 'slider', min: 1, max: 20, step: 0.5, unit: 'units', path: `visualisation.graphs.${graphName}.labels.maxLabelWidth`, description: 'Maximum label width before text wrapping.' },
      ...
      // labelDistance removed - not supported by backend LabelSettings
  ...
  [`${graphName}Physics`]: {
    ...
    settings: {
      ...
      attractionK: { label: 'Attraction Strength', type: 'slider', min: 0.001, max: 0.1, step: 0.001, path: `visualisation.graphs.${graphName}.physics.attractionK`, description: 'Force pulling connected nodes together.' },
      boundsSize: { label: 'Bounds Size', type: 'slider', min: 10, max: 2000, step: 10, unit: 'units', path: `visualisation.graphs.${graphName}.physics.boundsSize`, description: 'Simulation space boundaries.' },
      separationRadius: { label: 'Separation Radius', type: 'slider', min: 0.5, max: 100, step: 0.5, unit: 'units', path: `visualisation.graphs.${graphName}.physics.separationRadius`, description: 'Node separation distance for collision avoidance.' },
      damping: { label: 'Damping', type: 'slider', min: 0.5, max: 0.99, step: 0.01, path: `visualisation.graphs.${graphName}.physics.damping`, description: 'Velocity reduction factor (higher = slower settling).' },
      ...
      maxVelocity: { label: 'Max Velocity', type: 'slider', min: 0.1, max: 50.0, step: 0.1, unit: 'units/s', path: `visualisation.graphs.${graphName}.physics.maxVelocity`, description: 'Speed limit for node movement.' },
      repelK: { label: 'Repel K', type: 'slider', min: 0.01, max: 10.0, step: 0.01, path: `visualisation.graphs.${graphName}.physics.repelK`, description: 'Repulsion force constant.' },
      springK: { label: 'Spring K', type: 'slider', min: 0.01, max: 2.0, step: 0.01, path: `visualisation.graphs.${graphName}.physics.springK`, description: 'Spring force constant (edge stiffness).' },
      maxRepulsionDist: { label: 'Max Repulsion Distance', type: 'slider', min: 1, max: 1000, step: 1, unit: 'units', path: `visualisation.graphs.${graphName}.physics.maxRepulsionDist`, description: 'Maximum range of node repulsion effects.' },
      ...
      restLength: { label: 'Rest Length', type: 'slider', min: 10, max: 100, step: 1, path: `visualisation.graphs.${graphName}.physics.restLength`, description: 'Default rest length for spring forces.' },
      repulsionCutoff: { label: 'Repulsion Cutoff', type: 'slider', min: 10, max: 100, step: 1, path: `visualisation.graphs.${graphName}.physics.repulsionCutoff`, description: 'Maximum distance for repulsion calculations.' },
      ...
      centerGravityK: { label: 'Center Gravity K', type: 'slider', min: 0, max: 0.01, step: 0.0001, path: `visualisation.graphs.${graphName}.physics.centerGravityK`, description: 'Center gravity force constant.' },
      gridCellSize: { label: 'Grid Cell Size', type: 'slider', min: 10, max: 100, step: 1, path: `visualisation.graphs.${graphName}.physics.gridCellSize`, description: 'Spatial grid cell size for optimization.' },
      warmupIterations: { label: 'Warmup Iterations', type: 'slider', min: 10, max: 200, step: 10, path: `visualisation.graphs.${graphName}.physics.warmupIterations`, description: 'Number of warmup iterations before normal simulation.' },
      coolingRate: { label: 'Cooling Rate', type: 'slider', min: 0.0001, max: 0.01, step: 0.0001, path: `visualisation.graphs.${graphName}.physics.coolingRate`, description: 'Rate at which the system cools down during simulation.' },
      // Temperature and advanced physics settings
      temperature: { label: 'System Temperature', type: 'slider', min: 0, max: 10, step: 0.1, path: `visualisation.graphs.${graphName}.physics.temperature`, description: 'System temperature for simulated annealing.', isAdvanced: true },
      gravity: { label: 'Gravity', type: 'slider', min: -10, max: 10, step: 0.1, path: `visualisation.graphs.${graphName}.physics.gravity`, description: 'Gravitational force constant.', isAdvanced: true },
      stressWeight: { label: 'Stress Weight', type: 'slider', min: 0, max: 10, step: 0.1, path: `visualisation.graphs.${graphName}.physics.stressWeight`, description: 'Weight for stress minimization.', isAdvanced: true },
      stressAlpha: { label: 'Stress Alpha', type: 'slider', min: 0, max: 1, step: 0.01, path: `visualisation.graphs.${graphName}.physics.stressAlpha`, description: 'Alpha parameter for stress calculation.', isAdvanced: true },
      maxForce: { label: 'Max Force', type: 'slider', min: 0.1, max: 100, step: 0.1, path: `visualisation.graphs.${graphName}.physics.maxForce`, description: 'Maximum force limit.', isAdvanced: true },
      // Auto-balance configuration
      autoBalance: { label: 'Enable Auto-Balance', type: 'toggle', path: `visualisation.graphs.${graphName}.physics.autoBalance`, description: 'Enable automatic physics parameter balancing.' },
      autoBalanceIntervalMs: { label: 'Auto-Balance Interval', type: 'slider', min: 100, max: 5000, step: 100, unit: 'ms', path: `visualisation.graphs.${graphName}.physics.autoBalanceIntervalMs`, description: 'Interval for auto-balance checks.', isAdvanced: true },
      // Key auto-balance parameters for user fine-tuning
      stabilityVarianceThreshold: { label: 'Stability Variance Threshold', type: 'slider', min: 0.001, max: 1.0, step: 0.001, path: `visualisation.graphs.${graphName}.physics.autoBalanceConfig.stabilityVarianceThreshold`, description: 'Threshold for detecting system instability.', isAdvanced: true },
      clusteringDistanceThreshold: { label: 'Clustering Distance Threshold', type: 'slider', min: 1, max: 100, step: 1, path: `visualisation.graphs.${graphName}.physics.autoBalanceConfig.clusteringDistanceThreshold`, description: 'Distance threshold for clustering detection.', isAdvanced: true },
      boundaryMinDistance: { label: 'Boundary Min Distance', type: 'slider', min: 10, max: 200, step: 5, path: `visualisation.graphs.${graphName}.physics.autoBalanceConfig.boundaryMinDistance`, description: 'Minimum distance from boundaries.', isAdvanced: true },
      boundaryMaxDistance: { label: 'Boundary Max Distance', type: 'slider', min: 100, max: 2000, step: 50, path: `visualisation.graphs.${graphName}.physics.autoBalanceConfig.boundaryMaxDistance`, description: 'Maximum distance from boundaries.', isAdvanced: true },
    },
  },
});
  ...
  dashboard: {
    ...
    subsections: {
      overview: {
        ...
        settings: {
          graphStatus: { label: 'Graph Status', type: 'buttonAction', path: 'dashboard.graphStatus', description: 'View current graph statistics', action: () => logger.debug('Graph Status') },
          performance: { label: 'Performance Monitor', type: 'buttonAction', path: 'dashboard.performance', description: 'View performance metrics', action: () => logger.debug('Performance') },
          quickReset: { label: 'Reset View', type: 'buttonAction', path: 'dashboard.quickReset', description: 'Reset camera to default position', action: () => logger.debug('Reset View') },
          exportGraph: { label: 'Export Graph', type: 'buttonAction', path: 'dashboard.exportGraph', description: 'Export current graph data', action: () => logger.debug('Export') },
          importData: { label: 'Import Data', type: 'buttonAction', path: 'dashboard.importData', description: 'Import graph data from file', action: () => logger.debug('Import') },
        },
      },
    },
  },
  ...
  visualization: {
    ...
    subsections: {
      ...
      hologram: {
        ...
        settings: {
          ringCount: { label: 'Ring Count', type: 'slider', min: 0, max: 20, step: 1, path: 'visualisation.hologram.ringCount', description: 'Number of holographic rings around nodes.' },
          ...
          geodesicSize: { label: 'Geodesic Size', type: 'slider', min: 10, max: 150, step: 5, path: 'visualisation.hologram.geodesicSize', description: 'Size of geodesic hologram.' },
          ...
          triangleSphereSize: { label: 'Triangle Sphere Size', type: 'slider', min: 10, max: 150, step: 5, path: 'visualisation.hologram.triangleSphereSize', description: 'Size of triangle sphere hologram.' },
      ...
      animations: {
        label: 'Motion & Animation Effects',
        settings: {
      ...
      camera: {
        ...
        settings: {
          fov: { label: 'Field of View', type: 'slider', min: 30, max: 120, step: 1, unit: '°', path: 'visualisation.camera.fov', description: 'Camera field of view angle in degrees.' },
          near: { label: 'Near Plane', type: 'slider', min: 0.01, max: 10, step: 0.01, path: 'visualisation.camera.near', description: 'Near clipping plane distance.', isAdvanced: true },
          far: { label: 'Far Plane', type: 'slider', min: 100, max: 10000, step: 100, path: 'visualisation.camera.far', description: 'Far clipping plane distance.', isAdvanced: true },
          positionX: { label: 'Position X', type: 'slider', min: -1000, max: 1000, step: 10, path: 'visualisation.camera.position.x', description: 'Camera X position.', isAdvanced: true },
          positionY: { label: 'Position Y', type: 'slider', min: -1000, max: 1000, step: 10, path: 'visualisation.camera.position.y', description: 'Camera Y position.', isAdvanced: true },
          positionZ: { label: 'Position Z', type: 'slider', min: -1000, max: 1000, step: 10, path: 'visualisation.camera.position.z', description: 'Camera Z position.', isAdvanced: true },
          lookAtX: { label: 'Look At X', type: 'slider', min: -1000, max: 1000, step: 10, path: 'visualisation.camera.lookAt.x', description: 'Camera look-at X target.', isAdvanced: true },
          lookAtY: { label: 'Look At Y', type: 'slider', min: -1000, max: 1000, step: 10, path: 'visualisation.camera.lookAt.y', description: 'Camera look-at Y target.', isAdvanced: true },
          lookAtZ: { label: 'Look At Z', type: 'slider', min: -1000, max: 1000, step: 10, path: 'visualisation.camera.lookAt.z', description: 'Camera look-at Z target.', isAdvanced: true },
        },
      },
    },
  },
    ...
    subsections: {
      logseqPhysics: {
        ...
        settings: {
          ...
          attractionK: { label: 'Attraction Strength', type: 'slider', min: 0.001, max: 0.1, step: 0.001, path: 'visualisation.graphs.logseq.physics.attractionK', description: 'Force pulling connected nodes together.' },
          ...
          separationRadius: { label: 'Separation Radius', type: 'slider', min: 0.5, max: 100, step: 0.5, unit: 'units', path: 'visualisation.graphs.logseq.physics.separationRadius', description: 'Node separation distance for collision avoidance.' },
          ...
          springK: { label: 'Spring K', type: 'slider', min: 0.01, max: 2.0, step: 0.01, path: 'visualisation.graphs.logseq.physics.springK', description: 'Spring force constant (edge stiffness).' },
          ...
          damping: { label: 'Damping', type: 'slider', min: 0.5, max: 0.99, step: 0.01, path: 'visualisation.graphs.logseq.physics.damping', description: 'Velocity reduction factor (higher = slower settling).' },
          // CUDA kernel parameters
          ...
          centerGravityK: { label: 'Center Gravity K', type: 'slider', min: 0, max: 0.01, step: 0.0001, path: 'visualisation.graphs.logseq.physics.centerGravityK', description: 'Center gravity force constant.' },
          gridCellSize: { label: 'Grid Cell Size', type: 'slider', min: 10, max: 100, step: 1, path: 'visualisation.graphs.logseq.physics.gridCellSize', description: 'Spatial grid cell size for optimization.' },
          warmupIterations: { label: 'Warmup Iterations', type: 'slider', min: 10, max: 200, step: 10, path: 'visualisation.graphs.logseq.physics.warmupIterations', description: 'Number of warmup iterations before normal simulation.' },
          coolingRate: { label: 'Cooling Rate', type: 'slider', min: 0.0001, max: 0.01, step: 0.0001, path: 'visualisation.graphs.logseq.physics.coolingRate', description: 'Rate at which the system cools down during simulation.' },
        },
      },
      visionflowPhysics: {
        ...
        settings: {
          ...
          attractionK: { label: 'Attraction Strength', type: 'slider', min: 0.001, max: 0.1, step: 0.001, path: 'visualisation.graphs.visionflow.physics.attractionK', description: 'Force pulling connected nodes together.' },
          ...
          separationRadius: { label: 'Separation Radius', type: 'slider', min: 0.5, max: 100, step: 0.5, unit: 'units', path: 'visualisation.graphs.visionflow.physics.separationRadius', description: 'Node separation distance for collision avoidance.' },
          damping: { label: 'Damping', type: 'slider', min: 0.5, max: 0.99, step: 0.01, path: 'visualisation.graphs.visionflow.physics.damping', description: 'Velocity reduction factor (higher = slower settling).' },
          // CUDA kernel parameters
          ...
          centerGravityK: { label: 'Center Gravity K', type: 'slider', min: 0, max: 0.01, step: 0.0001, path: 'visualisation.graphs.visionflow.physics.centerGravityK', description: 'Center gravity force constant.' },
          gridCellSize: { label: 'Grid Cell Size', type: 'slider', min: 10, max: 100, step: 1, path: 'visualisation.graphs.visionflow.physics.gridCellSize', description: 'Spatial grid cell size for optimization.' },
          warmupIterations: { label: 'Warmup Iterations', type: 'slider', min: 10, max: 200, step: 10, path: 'visualisation.graphs.visionflow.physics.warmupIterations', description: 'Number of warmup iterations before normal simulation.' },
          coolingRate: { label: 'Cooling Rate', type: 'slider', min: 0.0001, max: 0.01, step: 0.0001, path: 'visualisation.graphs.visionflow.physics.coolingRate', description: 'Rate at which the system cools down during simulation.' },
          maxVelocity: { label: 'Max Velocity', type: 'slider', min: 0.1, max: 50.0, step: 0.1, unit: 'units/s', path: 'visualisation.graphs.visionflow.physics.maxVelocity', description: 'Speed limit for node movement.' },
          repelK: { label: 'Repel K', type: 'slider', min: 0.01, max: 10.0, step: 0.01, path: 'visualisation.graphs.visionflow.physics.repelK', description: 'Repulsion force constant.' },
          springK: { label: 'Spring K', type: 'slider', min: 0.01, max: 2.0, step: 0.01, path: 'visualisation.graphs.visionflow.physics.springK', description: 'Spring force constant (edge stiffness).' },
        },
      },
    },
  },
    ...
    subsections: {
      ...
      websocket: {
        ...
        settings: {
          ...
          maxMessageSize: { label: 'Max Message Size', type: 'slider', min: 1024, max: 1048576, step: 1024, unit: 'bytes', path: 'system.websocket.maxMessageSize', description: 'Maximum WebSocket message size.', isAdvanced: true },
          maxConnections: { label: 'Max Connections', type: 'slider', min: 1, max: 1000, step: 10, path: 'system.websocket.maxConnections', description: 'Maximum concurrent WebSocket connections.', isPowerUserOnly: true, isAdvanced: true },
          heartbeatInterval: { label: 'Heartbeat Interval', type: 'slider', min: 1000, max: 60000, step: 1000, unit: 'ms', path: 'system.websocket.heartbeatInterval', description: 'WebSocket heartbeat ping interval.', isAdvanced: true },
          heartbeatTimeout: { label: 'Heartbeat Timeout', type: 'slider', min: 1000, max: 30000, step: 1000, unit: 'ms', path: 'system.websocket.heartbeatTimeout', description: 'WebSocket heartbeat timeout.', isAdvanced: true },
        },
      },
      network: {
        label: 'Network Configuration',
        settings: {
          apiClientTimeout: { label: 'API Client Timeout', type: 'slider', min: 5, max: 300, step: 5, unit: 's', path: 'system.network.apiClientTimeout', description: 'HTTP client request timeout.' },
          enableMetrics: { label: 'Enable Metrics', type: 'toggle', path: 'system.network.enableMetrics', description: 'Enable network performance metrics collection.' },
          maxConcurrentRequests: { label: 'Max Concurrent Requests', type: 'slider', min: 1, max: 100, step: 1, path: 'system.network.maxConcurrentRequests', description: 'Maximum concurrent HTTP requests.' },
          maxRetries: { label: 'Max Retries', type: 'slider', min: 0, max: 10, step: 1, path: 'system.network.maxRetries', description: 'Maximum retry attempts for failed requests.' },
          retryDelay: { label: 'Retry Delay', type: 'slider', min: 100, max: 10000, step: 100, unit: 'ms', path: 'system.network.retryDelay', description: 'Delay between retry attempts.' },
          enableRateLimiting: { label: 'Enable Rate Limiting', type: 'toggle', path: 'system.network.enableRateLimiting', description: 'Enable server-side rate limiting.', isPowerUserOnly: true },
          rateLimitRequests: { label: 'Rate Limit Requests', type: 'slider', min: 1, max: 1000, step: 10, path: 'system.network.rateLimitRequests', description: 'Requests per time window for rate limiting.', isPowerUserOnly: true, isAdvanced: true },
          rateLimitWindow: { label: 'Rate Limit Window', type: 'slider', min: 1, max: 300, step: 1, unit: 's', path: 'system.network.rateLimitWindow', description: 'Time window for rate limiting.', isPowerUserOnly: true, isAdvanced: true },
        },
      },
      security: {
        label: 'Security Settings',
        settings: {
          enableAuditLogging: { label: 'Enable Audit Logging', type: 'toggle', path: 'system.security.enableAuditLogging', description: 'Log security events and access attempts.', isPowerUserOnly: true },
          enableRequestValidation: { label: 'Enable Request Validation', type: 'toggle', path: 'system.security.enableRequestValidation', description: 'Validate all incoming requests.', isPowerUserOnly: true },
          ...
          csrfTokenTimeout: { label: 'CSRF Token Timeout', type: 'slider', min: 5, max: 120, step: 5, unit: 'min', path: 'system.security.csrfTokenTimeout', description: 'CSRF token validity duration.', isAdvanced: true },
          cookieSecure: { label: 'Secure Cookies', type: 'toggle', path: 'system.security.cookieSecure', description: 'Require HTTPS for cookies.', isAdvanced: true },
          cookieHttponly: { label: 'HTTP-Only Cookies', type: 'toggle', path: 'system.security.cookieHttponly', description: 'Prevent JavaScript access to cookies.', isAdvanced: true },
          cookieSamesite: { label: 'Cookie SameSite', type: 'select', options: [{ value: 'strict', label: 'Strict' }, { value: 'lax', label: 'Lax' }, { value: 'none', label: 'None' }], path: 'system.security.cookieSamesite', description: 'Cookie SameSite attribute.', isAdvanced: true },
        },
      },
    ...
    subsections: {
      general: {
        ...
        settings: {
          ...
          mode: { label: 'XR Display Mode', type: 'select', options: [{value: 'inline', label: 'Inline (Desktop)'}, {value: 'immersive-vr', label: 'Immersive VR'}, {value: 'immersive-ar', label: 'Immersive AR'}], path: 'xr.mode', description: 'Preferred XR display mode.' },
          ...
          renderScale: { label: 'Render Scale', type: 'slider', min: 0.25, max: 2.0, step: 0.05, path: 'xr.renderScale', description: 'XR resolution multiplier (lower = better performance).' },
          interactionDistance: { label: 'Interaction Distance', type: 'slider', min: 0.1, max: 10.0, step: 0.1, unit: 'm', path: 'xr.interactionDistance', description: 'Maximum reach for hand/controller interactions.' },
          ...
          roomScale: { label: 'Room Scale Factor', type: 'slider', min: 0.1, max: 5.0, step: 0.1, path: 'xr.roomScale', description: 'Physical space scaling (1.0 = real world scale).' },
      ...
      handFeatures: {
        label: 'Hand & Controller Input',
        settings: {
          enableHandTracking: { label: 'Enable Hand Tracking', type: 'toggle', path: 'xr.enableHandTracking', description: 'Enable hand tracking in XR.' },
          ...
          hapticIntensity: { label: 'Haptic Intensity', type: 'slider', min: 0, max: 1.0, step: 0.01, path: 'xr.hapticIntensity', description: 'Controller vibration strength (0 = off, 1 = max).' },
          dragThreshold: { label: 'Drag Threshold', type: 'slider', min: 0.001, max: 0.5, step: 0.001, unit: 'm', path: 'xr.dragThreshold', description: 'Minimum movement to start dragging objects.' },
          pinchThreshold: { label: 'Pinch Threshold', type: 'slider', min: 0.01, max: 1.0, step: 0.01, path: 'xr.pinchThreshold', description: 'Hand pinch sensitivity (lower = more sensitive).' },
          ...
          movementSpeed: { label: 'Movement Speed', type: 'slider', min: 0.1, max: 10.0, step: 0.1, unit: 'm/s', path: 'xr.movementSpeed', description: 'Walking/flying speed in XR environment.' },
          ...
          interactionRadius: { label: 'Interaction Radius', type: 'slider', min: 0.01, max: 1.0, step: 0.01, unit: 'm', path: 'xr.interactionRadius', description: 'Touch interaction detection radius.' },
    ...
    subsections: {
      ragflow: {
        ...
        settings: {
          ...
          timeout: { label: 'API Timeout', type: 'slider', min: 5, max: 300, step: 5, unit: 'seconds', path: 'ragflow.timeout', description: 'Request timeout duration.' },
          maxRetries: { label: 'Max Retries', type: 'slider', min: 0, max: 20, step: 1, path: 'ragflow.maxRetries', description: 'Maximum retry attempts for failed requests.' },
      ...
      perplexity: {
        ...
        settings: {
          ...
          maxTokens: { label: 'Max Tokens', type: 'slider', min: 100, max: 131072, step: 256, path: 'perplexity.maxTokens', description: 'Maximum response length in tokens.' },
          temperature: { label: 'Temperature', type: 'slider', min: 0, max: 2.0, step: 0.05, path: 'perplexity.temperature', description: 'Response creativity (0 = deterministic, 2 = very creative).' },
          topP: { label: 'Top P', type: 'slider', min: 0.01, max: 1.0, step: 0.01, path: 'perplexity.topP', description: 'Response diversity control (lower = more focused).' },
      ...
      kokoro: {
        ...
        settings: {
          ...
          defaultSpeed: { label: 'Speech Speed', type: 'slider', min: 0.1, max: 4.0, step: 0.1, unit: 'x', path: 'kokoro.defaultSpeed', description: 'Text-to-speech playback speed multiplier.' },
      ...
      whisper: {
        ...
        settings: {
          ...
          returnTimestamps: { label: 'Return Timestamps', type: 'toggle', path: 'whisper.returnTimestamps', description: 'Include word-level timestamps in transcription.', isAdvanced: true },
          vadFilter: { label: 'VAD Filter', type: 'toggle', path: 'whisper.vadFilter', description: 'Use voice activity detection to filter silence.', isAdvanced: true },
          wordTimestamps: { label: 'Word Timestamps', type: 'toggle', path: 'whisper.wordTimestamps', description: 'Generate word-level timing information.', isAdvanced: true },
          initialPrompt: { label: 'Initial Prompt', type: 'textInput', path: 'whisper.initialPrompt', description: 'Optional initial prompt to guide transcription style.', isAdvanced: true },
        },
      },
    },
  },

  // PHASE 4: Consolidated Developer/Debug section from debugSettingsUIDefinition.ts
  developer: {
    label: 'Developer',
    subsections: {
      debugging: {
