...
interface VirtualizedSettingsGroupOptimizedProps {
  title: string;
  description?: string;
  items: SettingItem[];
  isPowerUser?: boolean;
...
export const VirtualizedSettingsGroupOptimized = memo(({
  title,
  description,
  items,
  isPowerUser = false,
  ...
  onSettingChange,
  groupIndex
}: VirtualizedSettingsGroupOptimizedProps) => {
...
VirtualizedSettingsGroupOptimized.displayName = 'VirtualizedSettingsGroupOptimized';