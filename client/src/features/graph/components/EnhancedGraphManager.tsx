...
import { createEventHandlers } from './EnhancedGraphManager_EventHandlers'

const logger = createLogger('EnhancedGraphManager')
...
const EnhancedGraphManager: React.FC = () => {
...
export default EnhancedGraphManager