...
import type { MCPMessage, MCPRequest, BotsAgent, BotsCommunication, TokenUsage } from '../types/BotsTypes';
...
export class MCPWebSocketService {
  ...
  async getAgents(): Promise<BotsAgent[]> {
  ...
  async getCommunications(filter: any = { type: 'communication' }): Promise<BotsCommunication[]> {
