...
**Status**: Draft
**Date**: 2026-02-14
**Scope**: VisionFlow server + client + agent platform
...
```
                    ...
                    │  NOT connected to VisionFlow Rust backend   │
                    └─────────────────────────────────────────────┘
```
...
Currently no embeddings exist in VisionFlow. The embedding pipeline must be built:
