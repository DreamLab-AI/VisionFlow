...
| **VisionClaw** | N/A (library, no dedicated broker runtime) | IS-Envelope spec owner (ADR-075); IRI parser for `did:nostr` | No dedicated broker runtime; judgment brokering is spec-only |
