---
title: GPU Actor Communication Flow
description: GPU actor communication flow using hexagonal CQRS architecture
...
This document provides a comprehensive overview of the GPU actor communication flow using the hexagonal CQRS architecture. The system uses **GraphServiceSupervisor** to coordinate with **GPUManagerActor**, which delegates to specialized GPU actors including **GPUResourceActor** and **ForceComputeActor**.
