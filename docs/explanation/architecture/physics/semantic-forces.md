...
**Research Context:** A major area of ontology visualization research is **visual debugging**—helping ontology engineers see where constraints are violated (e.g., an individual belonging to two disjoint classes).
