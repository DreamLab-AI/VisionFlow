...
1. **[Quick Start Guide](02-first-graph.md)** - Create your first graph in 5 minutes
...
- 
- [Quick Start Guide](02-first-graph.md)

---

**Navigation:**  | [🚀 Getting Started](./) | [📚 Guides](../guides/) | [🏗️ Architecture](../../explanations/architecture/)