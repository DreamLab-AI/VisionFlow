---
layout: default
title: Docker Compose Unified Configuration Guide
parent: Guides
nav_order: 6
description: Using the unified docker-compose configuration for development and production environments
---
