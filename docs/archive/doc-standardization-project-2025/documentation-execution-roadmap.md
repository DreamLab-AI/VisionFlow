...
- **Issue**: 8 SCREAMING-SNAKE-CASE files + 8 multi-agent-docker files
...
- **Service Catalog**: Document all 15+ service modules
  - `github-sync-service.rs`
  - `ontology-pipeline-service.rs`
  - `stress-majorization-service.rs`
  - `clustering-service.rs`
  - `inference-service.rs`
  - `github/` (3 modules)
...
- `/src/app-state.rs` (service initialization)
...
docs/NEO4j-integration-checklist.md (create or remove references)
docs/stress-majorization-checklist.md (create or remove references)
docs/pipeline-integration-checklist.md (create or remove references)
