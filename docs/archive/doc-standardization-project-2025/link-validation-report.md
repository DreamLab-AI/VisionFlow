...
- `../stress-majorization-checklist.md`
- `../NEO4j-integration-checklist.md`
- `../pipeline-integration-checklist.md`
...
./concepts/architecture/pipeline-integration.md
  → ../protocols/websocket-protocol.md
...
./guides/05-05-testing-guide.md
  → ../archive/legacy-docs-2025-10/troubleshooting/security-alert.md
