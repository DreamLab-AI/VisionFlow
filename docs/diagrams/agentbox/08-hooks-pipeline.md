...
sequenceDiagram
    ...
    Note over NM,EG: DIVERGENCE: this ORDER is true at verified_commit 2c521c5bb only.<br/>At agentbox b0c963c66 main#40;#41; is RESTRUCTURED, not shifted — the recipient<br/>egressDecision moves from line 450 #40;after readStdin, bodyForEvent and<br/>composeBody#41; to line 401, ahead of readStdin at line 407. Recipient admission<br/>then refuses BEFORE any turn text is read, which is a stronger property than<br/>the one drawn here. Re-draw from main#40;#41; at that sha before re-stamping —<br/>shifting these anchors would carry a false flow forward.
```
