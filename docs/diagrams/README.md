...
Citations resolve by exact match first, then by `/`-suffix against `sources:`; a bare basename that matches
more than one entry is an `ambiguous` warning — qualify it (`handlers/graph/mod.rs:40`). A repo-root file that
...
|----|-------|----------|-------|-----------|------|
| VF-01 | [Repo composition and the canon — document taxonomy, ADR lifecycle, index gate](visionflow/01-repo-composition-and-canon.md) | 14 | flowchart, stateDiagram-v2, erDiagram, sequenceDiagram | [BASELINE-visionflow.md](../../docs/BASELINE-visionflow.md), [README.md](../../docs/README.md), [repository-map.md](../../docs/architecture/repository-map.md) | ADR-2001, ADR-2002, ADR-2005, ADR-2006, ADR-2007, ADR-2010, ADR-2011, ADR-2012 |
...
| VF-03 | [Estate health — nightly CI collection, offline check, and the snapshot the site renders](visionflow/03-estate-health.md) | 11 | flowchart, sequenceDiagram, stateDiagram-v2, erDiagram | [BASELINE-visionflow.md](../../docs/BASELINE-visionflow.md), [repository-map.md](../../docs/architecture/repository-map.md) | ADR-2006, ADR-2008 |
...
| VF-05 | [Governance gates — every CI gate, what it reads, its pass/fail rule and whether it blocks](visionflow/05-governance-gates.md) | 13 | flowchart, sequenceDiagram, stateDiagram-v2 | [BASELINE-visionflow.md](../../docs/BASELINE-visionflow.md), [compatibility-matrix.md](../../docs/architecture/compatibility-matrix.md) | ADR-2005, ADR-2006, ADR-2010, ADR-2011 |
| VF-06 | [Diagram tooling — the report render gate and this tree's own generator](visionflow/06-diagram-tooling.md) | 14 | flowchart, sequenceDiagram | [BASELINE-visionflow.md](../../docs/BASELINE-visionflow.md) | ADR-2004 |
...
| VF-08 | [Compatibility matrix and dependency direction across the estate](visionflow/08-compatibility-and-dependency-direction.md) | 10 | flowchart, sequenceDiagram, stateDiagram-v2 | [compatibility-matrix.md](../../docs/architecture/compatibility-matrix.md), [repository-map.md](../../docs/architecture/repository-map.md), [BASELINE-visionflow.md](../../docs/BASELINE-visionflow.md) | ADR-2006, ADR-2007 |
...
| VC-03 | [Request lifecycle, identity and the RBAC lattice](visionclaw/03-request-lifecycle-and-rbac.md) | 17 | sequenceDiagram, flowchart | [IDENTITY-authority-chain.md](../../../project/docs/IDENTITY-authority-chain.md), [SECURITY-profiles.md](../../../project/docs/SECURITY-profiles.md), [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md) | ADR-2002, ADR-2003, ADR-2009, ADR-2010, ADR-2011, ADR-2012, ADR-2013, ADR-2026, ADR-2039, ADR-2043, ADR-2044 |
| VC-04 | [Handler internals — graph, state, and domain route families](visionclaw/04-handlers-graph-and-state.md) | 29 | sequenceDiagram, flowchart, classDiagram | [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md) | ADR-2005, ADR-2007, ADR-2011, ADR-2111 |
| VC-05 | [Governance and identity handler families](visionclaw/05-handlers-governance-and-identity.md) | 18 | sequenceDiagram, flowchart | [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md), [IDENTITY-authority-chain.md](../../../project/docs/IDENTITY-authority-chain.md) | ADR-2006, ADR-2010, ADR-2011, ADR-2013, ADR-2016, ADR-2020, ADR-2058, ADR-2067, ADR-2075, ADR-2090, ADR-2091, ADR-2093, ADR-2094 |
...
| VC-07 | [Hexagonal ports, adapters, the CQRS application layer and the crate split](visionclaw/07-hexagonal-ports-and-crates.md) | 12 | flowchart, sequenceDiagram, classDiagram | [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md) | ADR-2004, ADR-2005, ADR-2016 |
...
| VC-11 | [Physics step and force channels](visionclaw/11-physics-step-and-force-channels.md) | 10 | sequenceDiagram, flowchart, classDiagram, stateDiagram-v2 | [GPU-wire-abi.md](../../../project/docs/GPU-wire-abi.md), [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md) | ADR-2007, ADR-2028, ADR-2029, ADR-2055, ADR-2060 |
...
| VC-20 | [Ontology pipeline - OWL extraction, Oxigraph, Whelk reasoning, governed mutation](visionclaw/20-ontology-pipeline-oxigraph-whelk.md) | 13 | sequenceDiagram, erDiagram, classDiagram, flowchart | [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md) | ADR-2004, ADR-2071, ADR-2064, ADR-2066, ADR-2068 |
...
| VC-26 | [Solid Pod integration — embedded pod, proxy, client stack](visionclaw/26-solid-pod-and-jss.md) | 14 | flowchart, sequenceDiagram | [DATA-authority-erasure.md](../../../project/docs/DATA-authority-erasure.md), [IDENTITY-authority-chain.md](../../../project/docs/IDENTITY-authority-chain.md) | ADR-2067, ADR-2068, ADR-2070, ADR-2098, ADR-2106 |
| VC-27 | [Agent estate integration — MCP relay, discovery, monitoring, ingest](visionclaw/27-agent-integration-mcp-relay.md) | 13 | sequenceDiagram, classDiagram | [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md), [IDENTIFIER-taxonomy.md](../../../project/docs/IDENTIFIER-taxonomy.md) | ADR-2025, ADR-2058, ADR-2090, ADR-2091, ADR-2094 |
...
| VC-31 | [R3F/Three.js graph render pipeline and WASM scene effects](visionclaw/31-client-graph-render-pipeline.md) | 11 | flowchart, sequenceDiagram, classDiagram | [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md) |  |
...
| VC-35 | [Voice end to end — PTT, STT, intent, TTS](visionclaw/35-voice-end-to-end.md) | 13 | stateDiagram-v2, sequenceDiagram, classDiagram, flowchart | [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md), [IDENTITY-authority-chain.md](../../../project/docs/IDENTITY-authority-chain.md) | ADR-2002, ADR-2039, ADR-2075 |
| VC-36 | [Godot + gdext OpenXR immersive client](visionclaw/36-godot-xr-client.md) | 24 | sequenceDiagram, flowchart, stateDiagram-v2, classDiagram | [XR-client.md](../../../project/docs/XR-client.md), [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md) | ADR-2032, ADR-2033, ADR-2034, ADR-2035, ADR-2036, ADR-2039, ADR-2076, ADR-2079, ADR-2107, ADR-2108, ADR-2109 |
...
| AB-02 | [Boot sequence, supervision tree and readiness](agentbox/02-boot-sequence-and-readiness.md) | 23 | sequenceDiagram, flowchart, stateDiagram-v2 | [BASELINE-container.md](../../../project/agentbox/docs/BASELINE-container.md) | ADR-2003, ADR-2007, ADR-2028, ADR-2029, ADR-2034, ADR-2063, ADR-2080, ADR-2092, ADR-2104 |
...
| AB-05 | [Manifest gate catalogue, vault path authority and the agentbox.sh CLI](agentbox/05-manifest-gates-and-cli.md) | 13 | sequenceDiagram, flowchart, stateDiagram-v2 | [BASELINE-container.md](../../../project/agentbox/docs/BASELINE-container.md) | ADR-2003, ADR-2028, ADR-2029, ADR-2034, ADR-2036, ADR-2037, ADR-2038, ADR-2039, ADR-2080, ADR-2091, ADR-2092, ADR-2093, ADR-2094 |
| AB-06 | [Compose overlays, sidecar topology and the loopback-publish invariant](agentbox/06-sidecars-and-compose-overlays.md) | 10 | flowchart, sequenceDiagram | [BASELINE-container.md](../../../project/agentbox/docs/BASELINE-container.md) | ADR-2013, ADR-2003, ADR-2040, ADR-2094 |
...
| AB-16 | [Secrets custody, seccomp and runtime profiles](agentbox/16-secrets-custody-seccomp-profiles.md) | 12 | flowchart, classDiagram, sequenceDiagram, stateDiagram-v2 | [SECURITY-profiles.md](../../../project/agentbox/docs/SECURITY-profiles.md), [INGRESS-identity.md](../../../project/agentbox/docs/INGRESS-identity.md) | ADR-2007, ADR-2026, ADR-2027, ADR-2033, ADR-2046 |
| AB-17 | [Agent events and the BC20 provenance bridge](agentbox/17-agent-events-and-provenance-bridge.md) | 10 | classDiagram, sequenceDiagram | [PROTOCOL-registry.md](../../../project/agentbox/docs/PROTOCOL-registry.md), [INGRESS-identity.md](../../../project/agentbox/docs/INGRESS-identity.md) | ADR-2011, ADR-2022, ADR-2025, ADR-2061, ADR-2085 |
| AB-20 | [RuVector memory path — every MCP memory tool end to end](agentbox/20-ruvector-memory-path.md) | 13 | sequenceDiagram, flowchart, stateDiagram-v2, erDiagram | [LEARNING-memory.md](../../../project/agentbox/docs/LEARNING-memory.md) | ADR-2014, ADR-2018, ADR-2019, ADR-2051, ADR-2082 |
...
| AB-22 | [Skills estate — discovery, lint gate, the live router, harness and colloquy MCP bridges](agentbox/22-skills-and-routing.md) | 14 | sequenceDiagram, stateDiagram-v2, flowchart | [GOVERNANCE-capabilities.md](../../../project/agentbox/docs/GOVERNANCE-capabilities.md) | ADR-2020, ADR-2021, ADR-2028, ADR-2056, ADR-2057, ADR-2083, ADR-2085, ADR-2086, ADR-2089, ADR-2090, ADR-2091, ADR-2092 |
| AB-23 | [Dream machine — nightly cycle, gates and acceptance path](agentbox/23-dream-engine.md) | 16 | stateDiagram-v2, sequenceDiagram, classDiagram, flowchart | [GOVERNANCE-capabilities.md](../../../project/agentbox/docs/GOVERNANCE-capabilities.md) | ADR-2024, ADR-2053, ADR-2081, ADR-2084, ADR-2087 |
| AB-24 | [Ontology Loom facade and the model-swap seam](agentbox/24-loom-facade.md) | 11 | flowchart, sequenceDiagram, classDiagram, stateDiagram-v2 | [GOVERNANCE-capabilities.md](../../../project/agentbox/docs/GOVERNANCE-capabilities.md) | ADR-2023, ADR-2053, ADR-2055, ADR-2075, ADR-2084 |
| AB-25 | [Ontology tools and governed writes](agentbox/25-ontology-tools-and-governed-writes.md) | 12 | flowchart, sequenceDiagram, classDiagram, stateDiagram-v2 | [GOVERNANCE-capabilities.md](../../../project/agentbox/docs/GOVERNANCE-capabilities.md) | ADR-2022, ADR-2023, ADR-2028, ADR-2054 |
...
| ID | Topic | Diagrams | Kinds | Governing | ADRs |
|----|-------|----------|-------|-----------|------|
| SP-01 | [Workspace composition, crate dependency graph and the feature-flag matrix](solid-pod-rs/01-workspace-composition.md) | 13 | flowchart, classDiagram | [README.md](../../../solid-pod-rs/README.md), [BASELINE-solid-pod-rs.md](../../../solid-pod-rs/crates/solid-pod-rs/docs/BASELINE-solid-pod-rs.md), [ecosystem-integration.md](../../../solid-pod-rs/crates/solid-pod-rs/docs/explanation/ecosystem-integration.md) | ADR-2001, ADR-2004, ADR-2005 |
...
| SP-05 | [Identity — NIP-98, replay, did:nostr, did:key, WebID, Solid-OIDC and the IdP](solid-pod-rs/05-identity-nip98-did-oidc.md) | 21 | flowchart, sequenceDiagram, stateDiagram-v2, classDiagram | [README.md](../../../solid-pod-rs/README.md), [BASELINE-solid-pod-rs.md](../../../solid-pod-rs/crates/solid-pod-rs/docs/BASELINE-solid-pod-rs.md), [ecosystem-integration.md](../../../solid-pod-rs/crates/solid-pod-rs/docs/explanation/ecosystem-integration.md) | ADR-2003, ADR-2006 |
...
| SP-07 | [Provenance — git-marks, block-trails, Bitcoin anchoring — and the web ledger](solid-pod-rs/07-provenance-and-payments.md) | 18 | flowchart, stateDiagram-v2, sequenceDiagram, classDiagram | [README.md](../../../solid-pod-rs/README.md), [BASELINE-solid-pod-rs.md](../../../solid-pod-rs/crates/solid-pod-rs/docs/BASELINE-solid-pod-rs.md) | ADR-2004, ADR-2007, ADR-2008 |
| SP-08 | [Federation and outward surfaces — ActivityPub, NIP-01 relay, Solid Notifications, the forge, MCP](solid-pod-rs/08-federation-notifications-forge-mcp.md) | 17 | flowchart, sequenceDiagram, stateDiagram-v2, classDiagram | [README.md](../../../solid-pod-rs/README.md), [ecosystem-integration.md](../../../solid-pod-rs/crates/solid-pod-rs/docs/explanation/ecosystem-integration.md) | ADR-2005, ADR-2006 |
| SP-09 | [CI gates, the release pipeline, versioning and the consumer pin matrix](solid-pod-rs/09-ci-release-and-consumer-pins.md) | 12 | flowchart, sequenceDiagram | [README.md](../../../solid-pod-rs/README.md), [ecosystem-integration.md](../../../solid-pod-rs/crates/solid-pod-rs/docs/explanation/ecosystem-integration.md), [BASELINE-solid-pod-rs.md](../../../solid-pod-rs/crates/solid-pod-rs/docs/BASELINE-solid-pod-rs.md) | ADR-2001, ADR-2008 |
| SP-10 | [Failure modes, fail-closed boundaries and the invariant register](solid-pod-rs/10-failure-modes-and-invariants.md) | 12 | flowchart, sequenceDiagram | [README.md](../../../solid-pod-rs/README.md), [BASELINE-solid-pod-rs.md](../../../solid-pod-rs/crates/solid-pod-rs/docs/BASELINE-solid-pod-rs.md) | ADR-2002, ADR-2003, ADR-2004, ADR-2005, ADR-2006, ADR-2007 |
...
| NF-02 | [auth-worker — passkey ceremonies, NIP-98 gating, membership and the REST surface](nostr-rust-forum/02-auth-worker-passkey-nip98-and-membership.md) | 10 | sequenceDiagram, flowchart, stateDiagram-v2 | [IDENTITY-keys-and-trust.md](../../../nostr-rust-forum/docs/IDENTITY-keys-and-trust.md), [BASELINE-architecture.md](../../../nostr-rust-forum/docs/BASELINE-architecture.md) | ADR-2003, ADR-2004, ADR-2010, ADR-2011 |
| NF-03 | [relay-worker — NIP-42 AUTH, the EVENT admission pipeline, trust ladder and federation](nostr-rust-forum/03-relay-worker-admission-auth-and-trust.md) | 14 | flowchart, sequenceDiagram, stateDiagram-v2, classDiagram | [BASELINE-architecture.md](../../../nostr-rust-forum/docs/BASELINE-architecture.md), [IDENTITY-keys-and-trust.md](../../../nostr-rust-forum/docs/IDENTITY-keys-and-trust.md) | ADR-2004, ADR-2005, ADR-2006, ADR-2010, ADR-2011 |
| NF-04 | [pod-worker — Solid LDP surface, WAC evaluation, delegation, quota and payments](nostr-rust-forum/04-pod-worker-ldp-wac-and-delegation.md) | 11 | flowchart, sequenceDiagram, classDiagram | [BASELINE-architecture.md](../../../nostr-rust-forum/docs/BASELINE-architecture.md), [IDENTITY-keys-and-trust.md](../../../nostr-rust-forum/docs/IDENTITY-keys-and-trust.md) | ADR-2009, ADR-2007, ADR-2012 |
| NF-05 | [The two Leptos clients — boot, identity, transport, onboarding, messaging and the retro BBS](nostr-rust-forum/05-leptos-clients-onboarding-messaging-governance.md) | 14 | sequenceDiagram, flowchart, classDiagram, stateDiagram-v2 | [BASELINE-architecture.md](../../../nostr-rust-forum/docs/BASELINE-architecture.md), [IDENTITY-keys-and-trust.md](../../../nostr-rust-forum/docs/IDENTITY-keys-and-trust.md) | ADR-2008 |
| NF-06 | [Agent Control Surface Protocol — kinds 31400-31405, the broker aggregate and its consumers](nostr-rust-forum/06-agent-control-surface-31400-31405.md) | 15 | classDiagram, flowchart, sequenceDiagram, stateDiagram-v2, erDiagram | [BASELINE-architecture.md](../../../nostr-rust-forum/docs/BASELINE-architecture.md) | ADR-2010, ADR-2011 |
...
| NF-10 | [Invariants, the re-verified anomaly register and the doc-drift ledger](nostr-rust-forum/10-invariants-and-anomaly-register.md) | 11 | flowchart, sequenceDiagram | [BASELINE-architecture.md](../../../nostr-rust-forum/docs/BASELINE-architecture.md), [IDENTITY-keys-and-trust.md](../../../nostr-rust-forum/docs/IDENTITY-keys-and-trust.md) | ADR-2002, ADR-2003, ADR-2004, ADR-2005, ADR-2006, ADR-2007, ADR-2008, ADR-2009, ADR-2010 |
| NF-11 | [Inside the relay Durable Object — sessions, storage, filters, broadcast, projection, receipts and the scheduled sweeps](nostr-rust-forum/11-relay-durable-object-internals.md) | 15 | classDiagram, sequenceDiagram, flowchart, stateDiagram-v2 | [BASELINE-architecture.md](../../../nostr-rust-forum/docs/BASELINE-architecture.md), [IDENTITY-keys-and-trust.md](../../../nostr-rust-forum/docs/IDENTITY-keys-and-trust.md) | ADR-2005, ADR-2006, ADR-2010, ADR-2011 |
| NF-12 | [nostr-bbs-core wire and crypto primitives, and the nostr-bbs-mesh federation envelope](nostr-rust-forum/12-core-wire-crypto-and-federation-envelope.md) | 10 | flowchart, sequenceDiagram, classDiagram | [IDENTITY-keys-and-trust.md](../../../nostr-rust-forum/docs/IDENTITY-keys-and-trust.md), [BASELINE-architecture.md](../../../nostr-rust-forum/docs/BASELINE-architecture.md) | ADR-2002, ADR-2003, ADR-2005 |
...
| DW-03 | [forum-config overlay — zones, admin, KV and the hand-synced mirror set](dreamlab-ai-website/03-forum-config-overlay-zones-admin-kv-sync.md) | 11 | flowchart, stateDiagram-v2, sequenceDiagram | [BASELINE-architecture.md](../../../dreamlab-ai-website/docs/BASELINE-architecture.md) | ADR-2005, ADR-2007 |
...
| DW-05 | [CI gates — rust-ci, KIT_REF pin guard, playwright, config mirrors](dreamlab-ai-website/05-ci-gates-rust-ci-kit-pin-playwright.md) | 8 | flowchart, sequenceDiagram | [BASELINE-architecture.md](../../../dreamlab-ai-website/docs/BASELINE-architecture.md) | ADR-2004, ADR-2005 |
| DW-06 | [Content pipeline, ADR/security-doc inventory and the invariants register](dreamlab-ai-website/06-content-pipeline-and-invariants-register.md) | 8 | sequenceDiagram, flowchart | [BASELINE-architecture.md](../../../dreamlab-ai-website/docs/BASELINE-architecture.md), [IDENTITY-zones.md](../../../dreamlab-ai-website/docs/IDENTITY-zones.md) | ADR-2001, ADR-2002, ADR-2003, ADR-2004, ADR-2005, ADR-2006, ADR-2007, ADR-2008 |
| DW-07 | [Forum provisioning, seeding, embeddings, backup and migration tooling](dreamlab-ai-website/07-forum-provisioning-and-seeding.md) | 7 | flowchart, sequenceDiagram | [BASELINE-architecture.md](../../../dreamlab-ai-website/docs/BASELINE-architecture.md) | ADR-2005 |
...
| KG-02 | [Corpus → ontology build pipeline — census to graph tiers to manifest](knowledgegraph/02-corpus-to-ontology-pipeline.md) | 6 | flowchart, classDiagram, sequenceDiagram | [BASELINE-narrativegoldmine.md](../../../knowledgeGraph/docs/BASELINE-narrativegoldmine.md) | ADR-2001, ADR-2002, ADR-2003, ADR-2004 |
...
| KG-04 | [Explorer — NGG1 tier reader, worker transport, React SPA, and the externalised WASM crate](knowledgegraph/04-explorer-and-site-build.md) | 6 | flowchart, sequenceDiagram | [BASELINE-narrativegoldmine.md](../../../knowledgeGraph/docs/BASELINE-narrativegoldmine.md) | ADR-2001 |
...
| VG-02 | [Authoring → pipeline → published corpus — the 9-stage build and its swarm-authoring gates](visiongraph/02-authoring-to-pipeline-flow.md) | 7 | flowchart, sequenceDiagram, classDiagram | [PUBLICATION-contract.md](../../../visionGraph/docs/PUBLICATION-contract.md) | ADR-VG-002 |
...
| ID | Topic | Diagrams | Kinds | Governing | ADRs |
|----|-------|----------|-------|-----------|------|
| ES-01 | [Estate topology — substrates, network fabric, service ports, compose networks](estate/01-estate-topology.md) | 8 | flowchart, sequenceDiagram | [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md), [BASELINE-container.md](../../../project/agentbox/docs/BASELINE-container.md) | agentbox:ADR-2023, agentbox:ADR-2013, visionclaw:ADR-2027, visionclaw:ADR-2025, agentbox:ADR-2009, agentbox:ADR-2012, agentbox:ADR-2062, agentbox:ADR-2034, agentbox:ADR-2104, agentbox:ADR-2096, agentbox:ADR-2098 |
| ES-02 | [Agent-event path — agentbox action to rendered beam, plus legacy paths](estate/02-agent-events-agentbox-to-visionclaw.md) | 12 | sequenceDiagram, classDiagram, flowchart | [PROTOCOL-registry.md](../../../project/docs/PROTOCOL-registry.md), [GPU-wire-abi.md](../../../project/docs/GPU-wire-abi.md), [PROTOCOL-registry.md](../../../project/agentbox/docs/PROTOCOL-registry.md) | agentbox:ADR-2085, agentbox:ADR-2086, agentbox:ADR-2061, visionclaw:ADR-2020, visionclaw:ADR-2083, visionclaw:ADR-2084, visionclaw:ADR-2085, visionclaw:ADR-2088, visionclaw:ADR-2089, visionclaw:ADR-2090, visionclaw:ADR-2091 |
| ES-03 | [Cross-repo federation contract (agentbox <-> VisionClaw)](estate/03-cross-repo-federation-contract.md) | 12 | classDiagram, flowchart, sequenceDiagram | [IDENTIFIER-taxonomy.md](../../../project/docs/IDENTIFIER-taxonomy.md), [PROTOCOL-registry.md](../../../project/docs/PROTOCOL-registry.md), [PROTOCOL-registry.md](../../../project/agentbox/docs/PROTOCOL-registry.md), [DATA-authority-erasure.md](../../../project/docs/DATA-authority-erasure.md), [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md), [BASELINE-container.md](../../../project/agentbox/docs/BASELINE-container.md) | visionclaw:ADR-2023, visionclaw:ADR-2025, agentbox:ADR-2061, agentbox:ADR-2085, agentbox:ADR-2096, agentbox:ADR-2097, agentbox:ADR-2098, agentbox:ADR-2099, agentbox:ADR-2100, agentbox:ADR-2101, agentbox:ADR-2102, agentbox:ADR-2103, visionclaw:ADR-2111, visionflow:ADR-2012, solid-pod-rs:ADR-2008, nostr-rust-forum:ADR-2012 |
| ES-04 | [did:nostr identity mesh — signing, verification, custody](estate/04-identity-mesh-did-nostr.md) | 7 | flowchart, classDiagram, sequenceDiagram | [IDENTITY-authority-chain.md](../../../project/docs/IDENTITY-authority-chain.md), [INGRESS-identity.md](../../../project/agentbox/docs/INGRESS-identity.md), [BASELINE-container.md](../../../project/agentbox/docs/BASELINE-container.md), [SECURITY-profiles.md](../../../project/docs/SECURITY-profiles.md) | agentbox:ADR-2098, agentbox:ADR-2101, agentbox:ADR-2033, agentbox:ADR-2002, agentbox:ADR-2009, agentbox:ADR-2010, agentbox:ADR-2011, agentbox:ADR-2013, agentbox:ADR-2026 |
| ES-05 | [Human-approval governance loop across the estate](estate/05-governance-loop-across-estate.md) | 13 | flowchart, classDiagram, sequenceDiagram, stateDiagram-v2 | [GOVERNANCE-capabilities.md](../../../project/agentbox/docs/GOVERNANCE-capabilities.md), [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md) | visionclaw:ADR-2006, agentbox:ADR-2041, agentbox:ADR-2071, visionflow:ADR-2010, visionflow:ADR-2011, agentbox:ADR-2087, visionclaw:ADR-2110, nostr-rust-forum:ADR-2011, agentbox:ADR-2085, agentbox:ADR-2086 |
| ES-06 | [Ontology Loom and the email privacy path](estate/06-loom-and-email-privacy-path.md) | 11 | flowchart, sequenceDiagram, stateDiagram-v2 | [GOVERNANCE-capabilities.md](../../../project/agentbox/docs/GOVERNANCE-capabilities.md), [BASELINE-container.md](../../../project/agentbox/docs/BASELINE-container.md) | agentbox:ADR-2023, agentbox:ADR-2079, agentbox:ADR-2080, agentbox:ADR-2084, loom:ADR-139, agentbox:ADR-051 |
| ES-07 | [RuVector memory and embedding estate](estate/07-memory-and-embedding-estate.md) | 10 | flowchart, sequenceDiagram, stateDiagram-v2 | [LEARNING-memory.md](../../../project/agentbox/docs/LEARNING-memory.md), [DATA-authority-erasure.md](../../../project/docs/DATA-authority-erasure.md) | agentbox:ADR-2014, agentbox:ADR-2015, agentbox:ADR-2016, agentbox:ADR-2082 |
| ES-08 | [Solid-pod estate — four deployments, write identity, access control](estate/08-solid-pod-estate.md) | 12 | flowchart, sequenceDiagram, classDiagram, stateDiagram-v2 | [BASELINE-container.md](../../../project/agentbox/docs/BASELINE-container.md), [DATA-authority-erasure.md](../../../project/docs/DATA-authority-erasure.md), [INGRESS-identity.md](../../../project/agentbox/docs/INGRESS-identity.md) | solid-pod-rs:ADR-2008, nostr-rust-forum:ADR-2012, agentbox:ADR-2096, agentbox:ADR-2099, agentbox:ADR-2102, visionclaw:ADR-2111, visionclaw:ADR-2015, visionclaw:ADR-2016, visionclaw:ADR-2017, visionclaw:ADR-2064, visionclaw:ADR-2068, visionclaw:ADR-2106, agentbox:ADR-2064 |
| ES-09 | [Build, deploy and CI estate — source to running container, every gate](estate/09-build-deploy-and-ci-estate.md) | 23 | flowchart, sequenceDiagram, stateDiagram-v2 | [BASELINE-architecture.md](../../../project/docs/BASELINE-architecture.md), [BASELINE-container.md](../../../project/agentbox/docs/BASELINE-container.md) | visionclaw:ADR-2008, visionclaw:ADR-2037, agentbox:ADR-2013, agentbox:ADR-2028, agentbox:ADR-2039, agentbox:ADR-2056, agentbox:ADR-2082, agentbox:ADR-2083, agentbox:ADR-2085, agentbox:ADR-2091, agentbox:ADR-2092, agentbox:ADR-2093, agentbox:ADR-2094, visionclaw:ADR-2086 |
| ES-10 | [Deployment and security profiles across the estate](estate/10-deployment-and-security-profiles.md) | 11 | flowchart, sequenceDiagram, stateDiagram-v2 | [SECURITY-profiles.md](../../../project/docs/SECURITY-profiles.md), [SECURITY-profiles.md](../../../project/agentbox/docs/SECURITY-profiles.md), [INGRESS-identity.md](../../../project/agentbox/docs/INGRESS-identity.md), [IDENTITY-authority-chain.md](../../../project/docs/IDENTITY-authority-chain.md) | agentbox:ADR-2098, agentbox:ADR-2101, visionclaw:ADR-2003, visionclaw:ADR-2010, visionclaw:ADR-2012, agentbox:ADR-2012, agentbox:ADR-2013, visionclaw:ADR-2026, visionclaw:ADR-2027, agentbox:ADR-2027, visionclaw:ADR-2037, visionclaw:ADR-2038, visionclaw:ADR-2039, agentbox:ADR-2062, visionclaw:ADR-2086, visionclaw:ADR-2087 |
...
| ES-12 | [The Loom evaluation and its preregistration](estate/12-loom-evaluation-and-preregistration.md) | 7 | flowchart, stateDiagram-v2, sequenceDiagram | [LOOM-POSITIONING.md](../../../loom/docs/design/LOOM-POSITIONING.md), [PRD-025-ontology-loom-and-connector-platform.md](../../../loom/docs/design/PRD-025-ontology-loom-and-connector-platform.md) | loom:ADR-135, loom:ADR-136, loom:ADR-137, loom:ADR-138, loom:ADR-139, loom:PRD-025, loom:PRD-026, loom:PRD-027, loom:PRD-028, agentbox:ADR-051, agentbox:ADR-2023, agentbox:ADR-2084, agentbox:ADR-2095 |
| ES-90 | [Supporting repositories, evidence boundaries and closeout admission](estate/90-evidence-and-supporting-repositories.md) | 6 | flowchart, sequenceDiagram | [ADR-2007-estate-closeout-evidence-roadmap.md](../../docs/adr/ADR-2007-estate-closeout-evidence-roadmap.md), [repository-map.md](../../docs/architecture/repository-map.md) | visionflow:ADR-2004, visionflow:ADR-2006, visionflow:ADR-2007, dream-engine:ADR-0003, WasmVOWL:ADR-001 |
