...
| KG-02 | [Corpus → ontology build pipeline — census to graph tiers to manifest](knowledgegraph/02-corpus-to-ontology-pipeline.md) | 6 | flowchart, sequenceDiagram, classDiagram | [BASELINE-narrativegoldmine.md](../../../knowledgeGraph/docs/BASELINE-narrativegoldmine.md) | ADR-2001, ADR-2002, ADR-2003, ADR-2004 |
