...
[Quick Start](#-quick-start) | [Documentation](./ | [Benchmarks](#-performance) | [Roadmap](#-roadmap)
...
**Full benchmarks:** [docs/reference/performance-benchmarks.md](reference/performance-benchmarks.md)
...
|:-----|:--------|:-----------|
| **Tutorials** | Learning-oriented | [Installation](getting-started/installation.md), [First Graph](getting-started/first-graph.md) |
| **How-To Guides** | Task-oriented | [Agent Orchestration](guides/agent-orchestration.md), [XR Setup](guides/vircadia-xr-complete-guide.md) |
| **Explanations** | Understanding-oriented | [Architecture](architecture/overview.md), [Semantic Physics](docs/concepts/semantic-physics-system.md) |
| **Reference** | Information-oriented | [REST API](reference/api/rest-api-reference.md), [WebSocket Protocol](reference/websocket-protocol.md) |
