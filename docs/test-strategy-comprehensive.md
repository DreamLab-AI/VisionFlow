...
```rust
// /workspace/ext/tests/ptx_validation_comprehensive.rs
...
```rust
// /workspace/ext/tests/buffer_resize_integration.rs
...
```rust
// /workspace/ext/tests/constraint_stability_regression.rs
...
```rust
// /workspace/ext/tests/sssp_accuracy_validation.rs
...
```rust
// /workspace/ext/tests/gpu_kmeans_validation.rs
...
```rust
// /workspace/ext/tests/gpu_anomaly_validation.rs
...
```rust
// /workspace/ext/tests/spatial_hashing_efficiency.rs
...
```rust
// /workspace/ext/tests/performance_benchmarks.rs
...
jobs:
  gpu-tests:
    ...
    - name: Verify GPU Access
      run: |
        nvidia-smi
        cd /workspace/ext && echo "GPU available for testing"
    ...
    - name: Upload Test Results
      ...
      with:
        ...
        path: /workspace/ext/test-results.json
```
