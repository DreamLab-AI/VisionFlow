...
| CP-05 Human judgement and governance | Forum, agentbox, VisionClaw, commercial website | Human intent and rationale bound to exact request; atomic/recoverable decision projection; applied/rejected acknowledgement; supersession and appeal propagated safely; discharges augmentation conditions C2 and C3 ([ADR-2010](../../adr/ADR-2010-augmentation-conditions-are-the-canon-audit-lens.md)) — cannot exit while either is `absent` on a 31403-publishing or -consuming substrate | Governance and product maintainers | CP-03, CP-04 |
...
| CP-07 Memory and improvement | RuVector consumed modules, agentbox, dream-engine | Compatible embedding/persistence and privacy; repeatable recall; tested candidate bound to acceptance; fair scheduling and restart recovery; human learning measured, not only agent learning — augmentation condition C4 ([ADR-2010](../../adr/ADR-2010-augmentation-conditions-are-the-canon-audit-lens.md)); cannot exit while C4 is `absent` for humans | Memory/evaluation maintainers | CP-01, CP-03, CP-04 |
