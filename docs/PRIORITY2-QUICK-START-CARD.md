...
**Developers (30 min)**: Read `/docs/PRIORITY2_IMPLEMENTATION_GUIDE.md`
...
**Full commands in**: `PRIORITY2_IMPLEMENTATION_GUIDE.md`
...
- PRIORITY2_IMPLEMENTATION_GUIDE.md (how-to)
