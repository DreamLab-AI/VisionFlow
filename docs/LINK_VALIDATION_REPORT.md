...
🔗 LINK VALIDATION RESULTS:
  ❌ BROKEN LINKS (1979):
     ...
     • reference/architecture/database-schema.md
       └─> ./architecture.md (target not found: reference/architecture/architecture.md)
     • reference/architecture/hexagonal-cqrs.md
       └─> ./architecture.md (target not found: reference/architecture/architecture.md)
     • reference/configuration.md
       └─> ../guides/01-deployment.md (target not found: guides/01-deployment.md)
     • reference/configuration.md
       └─> ../guides/02-development-workflow.md (target not found: guides/02-development-workflow.md)
     • reference/configuration.md
     ...
     • reference/polling-system.md
       └─> api/client-api.md (target not found: api/client-api.md)
     • reference/polling-system.md
       └─> api/websocket-api.md (target not found: api/websocket-api.md)
     • reference/xr-api.md
       └─> /docs/architecture/VircadiaIntegration.md (target not found: /docs/architecture/VircadiaIntegration.md)
     ...
     • specialized/ontology/README.md
       └─> ontology-api-reference.md (target not found: ontology-api-reference.md)
     • specialized/ontology/README.md
       └─> ontology-integration-summary.md (target not found: ontology-integration-summary.md)
     • specialized/ontology/README.md
       └─> ontology-system-overview.md (target not found: ontology-system-overview.md)
     • specialized/ontology/README.md
       └─> ontology-user-guide.md (target not found: ontology-user-guide.md)
     • specialized/ontology/hornedowl.md
       └─> ../../client/features/gpu-analytics.md (target not found: client/features/gpu-analytics.md)
     • specialized/ontology/hornedowl.md
       └─> ../../features/adaptive-balancing.md (target not found: features/adaptive-balancing.md)
     • specialized/ontology/hornedowl.md
       └─> ../../features/agent-orchestration.md (target not found: features/agent-orchestration.md)
     • specialized/ontology/hornedowl.md
       └─> ../../features/auto-balance.md (target not found: features/auto-balance.md)
     • specialized/ontology/hornedowl.md
       └─> ../../features/index.md (target not found: features/index.md)
     • specialized/ontology/hornedowl.md
       └─> ontology-api-reference.md (target not found: ontology-api-reference.md)
     • specialized/ontology/hornedowl.md
       └─> ontology-system-overview.md (target not found: ontology-system-overview.md)
     • specialized/ontology/hornedowl.md
       └─> ontology-user-guide.md (target not found: ontology-user-guide.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/actors.md (target not found: server/actors.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/agent-swarm.md (target not found: server/agent-swarm.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/ai-services.md (target not found: server/ai-services.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/architecture.md (target not found: server/architecture.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/config.md (target not found: server/config.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/feature-access.md (target not found: server/feature-access.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/features/claude-flow-mcp-integration.md (target not found: server/features/claude-flow-mcp-integration.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/features/clustering.md (target not found: server/features/clustering.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/features/semantic-analysis.md (target not found: server/features/semantic-analysis.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/gpu-compute.md (target not found: server/gpu-compute.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/handlers.md (target not found: server/handlers.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/index.md (target not found: server/index.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/mcp-integration.md (target not found: server/mcp-integration.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/models.md (target not found: server/models.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/physics-engine.md (target not found: server/physics-engine.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/services.md (target not found: server/services.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/types.md (target not found: server/types.md)
     • specialized/ontology/hornedowl.md
       └─> ../../server/utils.md (target not found: server/utils.md)
     • specialized/ontology/hornedowl.md
       └─> ../index.md (target not found: specialized/index.md)
     • specialized/ontology/hornedowl.md
       └─> ../server/features/index.md (target not found: specialized/server/features/index.md)
     • user-guide/06-faq.md
       └─> ../api/authentication.md (target not found: api/authentication.md)
...
🗺️  NAVIGATION STRUCTURE VALIDATION:
  ...
  ❌ docs/reference/architecture/README.md (MISSING)
  ❌ docs/getting-started/01-installation.md (MISSING)
