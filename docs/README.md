...
| [Diagrams as code](diagrams/README.md) | Estate-wide, citation-verified Mermaid coverage of all ten repositories (VF/VC/AB/SP/NF/DW/VW/KG/VG/SR/ES areas), with a generated coverage index |
