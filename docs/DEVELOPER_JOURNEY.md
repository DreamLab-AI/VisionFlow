...
description: Practical guide for new developers to understand, navigate, and contribute to VisionFlow
nav_order: 6
...
**Next Step:** [Development Setup Guide](guides/developer/01-development-setup.md) (comprehensive instructions)
...
**Next Step:** [Contributing Guide](guides/developer/06-contributing.md) (PR guidelines, code style)
...
**Next Step:** [Project Structure Guide](guides/developer/02-project-structure.md) (detailed walkthrough)
...
**Next Step:** [Adding Features Guide](guides/developer/04-adding-features.md) (comprehensive patterns)
...
**Next Step:** [Testing Guide](guides/testing-guide.md) (comprehensive testing strategies)
...
**Read:** [Modular Actor System](guides/graphserviceactor-migration.md)
...
**Read:** [Ontology Reasoning Integration](guides/ontology-reasoning-integration.md)
...
- [FAQ](guides/troubleshooting.md#faq) - Frequently asked questions
...
**Next Steps:**
- [Development Setup](guides/developer/01-development-setup.md) - Get started
- [Project Structure](guides/developer/02-project-structure.md) - Explore the code
- [Adding Features](guides/developer/04-adding-features.md) - Build something new
- [Contributing Guide](guides/developer/06-contributing.md) - Submit your work
