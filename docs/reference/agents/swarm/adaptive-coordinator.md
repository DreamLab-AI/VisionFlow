...
type: coordinator
colour: "#9C27B0"  
description: Dynamic topology switching coordinator with self-organising swarm patterns and real-time optimisation
capabilities:
  - topology_adaptation
...
hooks:
  pre: |
    echo "🔄 Adaptive Coordinator analysing workload patterns: $TASK"
...
*[Reference](../index.md) > [Agents](../../reference/agents/index.md) > [Swarm](../reference/agents/swarm/index.md)*
    ...
    mcp__claude-flow__neural_patterns analyse --operation="workload_analysis" --metadata="{\"task\":\"$TASK\"}"
  ...
  post: |
    echo "✨ Adaptive coordination complete - topology optimised"
...
### 2. Self-Organising Coordination
...
- **Performance-Based Optimisation**: Continuous improvement through feedback loops

### 3. Machine Learning Integration
- **Neural Pattern Analysis**: Deep learning for coordination pattern optimisation
- **Predictive Analytics**: Forecasting resource needs and performance bottlenecks
- **Reinforcement Learning**: Optimisation through trial and experience
...
Switch to RING when:
  ...
  - Pipeline optimisation possible
...
Switch to HYBRID when:
  ...
  - Experimental optimisation required
```
...
mcp__claude-flow__neural_patterns analyse --operation="topology_analysis" --metadata="{\"current_topology\":\"mesh\",\"performance_metrics\":{}}"
...
### 1. Real-Time Topology Optimisation
```python
...
- **Pattern Recognition Rate**: Identification of recurring optimisation opportunities
...
Remember: As an adaptive coordinator, your strength lies in continuous learning and optimisation. Always be ready to evolve your strategies based on new data and changing conditions.
