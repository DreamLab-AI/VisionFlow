...
tools:
  ...
  restricted:
    ...
    - Bash
triggers:
  - pattern: "analyse.*performance|bottleneck|slow.*execution"
    priority: high
  - keyword: "performance-analyser"
---
```
...
tools:
  ...
  restricted:
    ...
    - Bash
triggers:
  - pattern: "token.*usage|analyse.*cost|efficiency.*report"
    priority: medium
  - keyword: "token-analyser"
---
```
