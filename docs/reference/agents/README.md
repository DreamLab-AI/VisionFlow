...
*[Reference](../index.md) > [Agents](./index.md)*
...
Agent references and documentation are organized hierarchically by type and purpose. See the directory structure above for complete organization.

For detailed agent specifications, see individual agent files in the subdirectories:
- **Core Agents**: `core/` directory
- **Development Agents**: `development/` directory
- **Testing Agents**: `testing/` directory
- **Architecture Agents**: `architecture/` directory
- **GitHub/Workflow Agents**: `github/` directory
- **Consensus Agents**: `consensus/` directory
- **Swarm Coordination**: `swarm/` directory
- **Templates**: `templates/` directory
- **Specialized Agents**: `specialized/` directory

See `index.md` for complete agent listing.
