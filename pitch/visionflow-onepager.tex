...
\begin{minipage}[t]{0.60\linewidth}
  ...
  {\scriptsize\color{textmuted}The open-source coordination harness where diverse intelligence collaborates across trust boundaries at scale. Self-sovereign data. Formal reasoning. Cryptographic provenance. Human-in-the-loop governance.}
\end{minipage}%
\hfill
\begin{minipage}[t]{0.36\linewidth}
  ...
  \begin{tabular}{r@{\;}l}
    ...
    \color{textmuted}Licence & MPL 2.0 / AGPL 3.0 \\
  \end{tabular}}
\end{minipage}
...
{\scriptsize Climate modelling, drug discovery, creative production at scale --- these require diverse intelligence collaborating across trust boundaries where centralised coordination breaks down.}
...
\begin{itemize}[leftmargin=8pt,itemsep=0pt,parsep=0pt,topsep=1pt,label={}]
  ...
  \item {\color{emerald}\textbullet} {\scriptsize\bfseries 10,000:1 problem-to-token ratio} {\scriptsize\color{textmuted}--- \$2.6B drug compounds justify \$10K--100K coordinated reasoning if one wrong conclusion is prevented}
...
{\scriptsize Every actor---human, agent, server---shares a \texttt{did:nostr} secp256k1 keypair verified at every layer.}
...
{\small\bfseries The Judgment Broker}\\[1pt]
...
\vspace{-2pt}
\begin{center}
  \includegraphics[width=0.95\linewidth]{ecosystem-overview.png}
\end{center}

\vspace{1pt}

\sectiontag{Strategic Position}
{\small\bfseries Three structural gaps no competitor can close}\\[2pt]

{\scriptsize\renewcommand{\arraystretch}{1.1}
\begin{tabularx}{\linewidth}{@{}l@{\hspace{4pt}}c@{\hspace{4pt}}c@{\hspace{4pt}}c@{\hspace{4pt}}c@{\hspace{4pt}}c@{}}
  \toprule
  & {\tiny\bfseries\color{textmuted}Crypto ID} & {\tiny\bfseries\color{textmuted}Sovereign} & {\tiny\bfseries\color{textmuted}Govern.} & {\tiny\bfseries\color{textmuted}OWL\,2} & {\tiny\bfseries\color{textmuted}Federated} \\
  \midrule
  \rowcolor{cardbg}
  {\scriptsize\bfseries VisionFlow} & {\color{emerald}\faCheck} & {\color{emerald}\faCheck} & {\color{emerald}\faCheck} & {\color{emerald}\faCheck} & {\color{emerald}\faCheck} \\
  {\scriptsize Google Spark} & {\color{crimson}\faTimes} & {\color{crimson}\faTimes} & {\color{gold}\footnotesize$\sim$} & {\color{crimson}\faTimes} & {\color{crimson}\faTimes} \\
  {\scriptsize OpenAI Codex} & {\color{crimson}\faTimes} & {\color{crimson}\faTimes} & {\color{crimson}\faTimes} & {\color{crimson}\faTimes} & {\color{crimson}\faTimes} \\
  {\scriptsize Claude Code} & {\color{crimson}\faTimes} & {\color{gold}\footnotesize$\sim$} & {\color{gold}\footnotesize$\sim$} & {\color{crimson}\faTimes} & {\color{gold}\footnotesize$\sim$} \\
  {\scriptsize CrewAI} & {\color{crimson}\faTimes} & {\color{gold}\footnotesize$\sim$} & {\color{gold}\footnotesize$\sim$} & {\color{crimson}\faTimes} & {\color{gold}\footnotesize$\sim$} \\
  {\scriptsize LangGraph} & {\color{crimson}\faTimes} & {\color{gold}\footnotesize$\sim$} & {\color{gold}\footnotesize$\sim$} & {\color{crimson}\faTimes} & {\color{gold}\footnotesize$\sim$} \\
  \bottomrule
\end{tabularx}}

\vspace{2pt}
{\tiny\color{textmuted}{\color{emerald}\faCheck}\,Protocol-native \quad {\color{gold}$\sim$}\,Partial/add-on \quad {\color{crimson}\faTimes}\,Absent}
...
\begin{tikzpicture}
  \node[draw=cyan,fill=cardbg,rounded corners=3pt,
    ...
    {\tiny\color{emerald}\href{mailto:anthropic@xrsystems.uk}{anthropic@xrsystems.uk}}
  };
\end{tikzpicture}
\end{center}
