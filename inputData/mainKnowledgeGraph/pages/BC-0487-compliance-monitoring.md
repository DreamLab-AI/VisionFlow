...
(AnnotationAssertion rdfs:comment :ComplianceMonitoring "A component of the blockchain ecosystem."@en)
	  ...
	  collapsed:: true
		...
		- #### Monitoring Approaches
			- **Rule-Based Systems**: Traditional scenario-based monitoring using predefined thresholds and patterns:
				...
				- Rapid movement through multiple addresses (velocity cheques)
	  ...
	  collapsed:: true
		...
		- #### Operational Costs
			- **Small Exchange (10,000-50,000 users)**:
				- Blockchain analytics licencing: $50,000-$150,000 annually
	...
	- ### Future Developments and Trends
	  collapsed:: true
		- #### Emerging Technologies
			- **AI-Powered Investigation**: Next-generation systems using large language models to draught investigation narratives, identify relevant transactions, and generate SAR content
