- ### OntologyBlock
  ...
  - #### CrossDomainBridges
    - bridges-from:: [[ForkChoiceRule]] via is-subclass-of
    - bridges-from:: [[MerkleTree]] via is-subclass-of
    - bridges-from:: [[Keccak256]] via is-subclass-of
    - bridges-from:: [[Term]] via is-subclass-of
    - bridges-from:: [[MerkleProof]] via is-subclass-of
    - bridges-from:: [[ChainState]] via is-subclass-of
    - bridges-from:: [[PermissionlessNetwork]] via is-subclass-of
    - bridges-from:: [[NetworkTopology]] via is-subclass-of
    - bridges-from:: [[Output]] via is-subclass-of
    - bridges-from:: [[ValidatorNode]] via is-subclass-of
    - bridges-from:: [[PrunedNode]] via is-subclass-of
    - bridges-from:: [[CryptographicCommitment]] via is-subclass-of
    - bridges-from:: [[PublicKey]] via is-subclass-of
    - bridges-from:: [[SignatureScheme]] via is-subclass-of
    - bridges-from:: [[Nonce]] via is-subclass-of
    - bridges-from:: [[HashFunction]] via is-subclass-of
    - bridges-from:: [[BlockchainNetwork]] via is-subclass-of
    - bridges-from:: [[SybilAttack]] via is-subclass-of
    - bridges-from:: [[HashCollision]] via is-subclass-of
    - bridges-from:: [[PeerDiscovery]] via is-subclass-of
    - bridges-from:: [[ConsensusRule]] via is-subclass-of
    - bridges-from:: [[Ecdsa]] via is-subclass-of
    - bridges-from:: [[EllipticCurveCryptography]] via is-subclass-of
    - bridges-from:: [[MerkleRoot]] via is-subclass-of
    - bridges-from:: [[NetworkSynchronization]] via is-subclass-of
    - bridges-from:: [[PublicKeyCryptography]] via is-subclass-of
    - bridges-from:: [[Input]] via is-subclass-of
    - bridges-from:: [[DigitalSignature]] via is-subclass-of
    - bridges-from:: [[Immutability]] via is-subclass-of
    - bridges-from:: [[Finality]] via is-subclass-of
    - bridges-from:: [[DoubleSpending]] via is-subclass-of
    - bridges-from:: [[SoloMining]] via is-subclass-of
    - bridges-from:: [[GossipProtocol]] via is-subclass-of
    - bridges-from:: [[PermissionedNetwork]] via is-subclass-of
    - bridges-from:: [[CensorshipResistance]] via is-subclass-of
    - bridges-from:: [[Gas]] via is-subclass-of
    - bridges-from:: [[Halving]] via is-subclass-of
    - bridges-from:: [[NativeToken]] via is-subclass-of
    - bridges-from:: [[OrphanBlock]] via is-subclass-of
    - bridges-from:: [[Opcodes]] via is-subclass-of
    - bridges-from:: [[PrivateKey]] via is-subclass-of
    - bridges-from:: [[FullNode]] via is-subclass-of
    - bridges-from:: [[ChainReorganization]] via is-subclass-of
    - bridges-from:: [[LongestChainRule]] via is-subclass-of
    - bridges-from:: [[Transaction]] via is-subclass-of
    - bridges-from:: [[SchnorrSignature]] via is-subclass-of
    - bridges-from:: [[PartitionAttack]] via is-subclass-of
    - bridges-from:: [[Miner]] via is-subclass-of
    - bridges-from:: [[DifficultyTarget]] via is-subclass-of
    - bridges-from:: [[CoinbaseTransaction]] via is-subclass-of
    - bridges-from:: [[SelfishMining]] via is-subclass-of
    - bridges-from:: [[NetworkHashRate]] via is-subclass-of
    - bridges-from:: [[DifficultyAdjustment]] via is-subclass-of
    - bridges-from:: [[NetworkLatency]] via is-subclass-of
    - bridges-from:: [[PoolShare]] via is-subclass-of
    - bridges-from:: [[Decentralization]] via is-subclass-of
    - bridges-from:: [[UtxoModel]] via is-subclass-of
    - bridges-from:: [[Node]] via is-subclass-of
    - bridges-from:: [[GenesisBlock]] via is-subclass-of
    - bridges-from:: [[Script]] via is-subclass-of
    - bridges-from:: [[PreimageResistance]] via is-subclass-of
    - bridges-from:: [[Timestamp]] via is-subclass-of
    - bridges-from:: [[TransactionConfirmation]] via is-subclass-of
    - bridges-from:: [[Difficulty]] via is-subclass-of
    - bridges-from:: [[Coin]] via is-subclass-of
    - bridges-from:: [[ZeroKnowledgeProof]] via is-subclass-of
    - bridges-from:: [[CollisionResistance]] via is-subclass-of
    - bridges-from:: [[ProofOfWork]] via is-subclass-of
    - bridges-from:: [[BootstrapNode]] via is-subclass-of
    - bridges-from:: [[Mining]] via is-subclass-of
    - bridges-from:: [[PeerToPeerNetwork]] via is-subclass-of
    - bridges-from:: [[EclipseAttack]] via is-subclass-of
    - bridges-from:: [[TransactionPool]] via is-subclass-of
    - bridges-from:: [[LightNode]] via is-subclass-of
    - bridges-from:: [[Mempool]] via is-subclass-of
    - bridges-from:: [[MiningPool]] via is-subclass-of
    - bridges-from:: [[NakamotoConsensus]] via is-subclass-of
    - bridges-from:: [[MiningReward]] via is-subclass-of
    - bridges-from:: [[Salt]] via is-subclass-of
...
Ontology(<http://narrativegoldmine.com/blockchain/PC-0001>
...
- ## About Blockchain Entity
  ...
  - ### Key Characteristics
    ...
    - **Decentralized Coordination**: Entities operate within decentralized frameworks without centralised control points
