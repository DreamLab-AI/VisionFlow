	  ...
	  id:: 66314b8e-513e-45a6-80e7-493933e46e9e
		- ```graphviz
		  digraph G {
		    ...
		    edge [colour=darkslategray, penwidth=1];
		
		    // Main Themes
		    // The main themes represent the key areas of focus in the diagram. The skyblue colour provides a soft and pleasant visual appearance.
		    ...
		    // These nodes represent various decentralized technologies. The mediumseagreen colour provides good readability against the dark font colour.
		    ...
		    // AI Technologies
		    // These nodes represent various AI technologies. The moccasin colour provides a warm and distinct appearance.
		    ...
		    // XR Technologies
		    // These nodes represent various XR technologies. The lightpink colour provides a visually appealing and distinguishable appearance.
		    ...
		    // These nodes represent different intellectual work packages. The thistle colour provides a subtle and distinguishable appearance.
		    ...
		    // Agentic AI Actors
		    // This node represents agentic AI actors. The lightsalmon colour provides a vibrant and noticeable appearance.
...
- {{renderer code_diagram,graphviz}}
	- ```graphviz digraph G {	
	      // Global settings
	      rankdir=LR;
	      node [shape=rectangle, style=filled, colour=lightblue];
	      edge [colour=black, penwidth=1.5];
	
	      // Define nodes
	      node1 [label="Start", shape=ellipse, colour=lightgreen];
	      node2 [label="Process 1"];
	      node3 [label="Decision", shape=diamond, fillcolor=yellow];
	      node4 [label="Process 2"];
	      node5 [label="End", shape=ellipse, colour=red];
