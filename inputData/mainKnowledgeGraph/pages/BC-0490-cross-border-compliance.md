...
(AnnotationAssertion rdfs:comment :CrossBorderCompliance "A component of the blockchain ecosystem."@en)
...
- ## About Cross Border Compliance
	  ...
	  collapsed:: true
		- #### Regulatory Regime Diversity
			- **Licensing Requirements**: Each jurisdiction imposes distinct authorisation frameworks
				- **US**: State-by-state money transmitter licences (48+ jurisdictions) plus federal oversight ([[BC-0488-licencing-requirements]])
				- **UK**: [[FCA]] registration under Money Laundering Regulations with ~25% approval rate
				- **Singapore**: [[MAS]] Payment Services Act licencing with 20% approval rate and physical presence requirements
				- **EU**: National frameworks being replaced by harmonised [[BC-0484-markets-in-crypto-assets]] (MiCA) licencing (effective December 2024)
				- **Result**: Platform seeking global coverage faces 50-100 separate licencing applications costing $50-150M total
			...
			- **Permissible Services**: Jurisdictions differ dramatically on allowed activities
				...
				- **Lending/Yield Products**: Classified as securities in many jurisdictions (requiring separate licencing), unregulated elsewhere
	  ...
	  collapsed:: true
		- #### Historical Arbitrage Strategies
			- **Offshore Licensing Centres**: Platforms historically sought "crypto-friendly" jurisdictions
				- **Malta**: "Blockchain Island" strategy (2018-2020) attracted [[Binance]], [[OKEx]], others
					- Low licencing fees, fast approvals, favourable tax treatment
			...
			- **"Nowhere and Everywhere" Strategy**: Some platforms avoided clear jurisdictional nexus
				- **Binance (2017-2021)**: No declared headquarters, CEO claimed to "live on planes"
					- Served global customers without comprehensive licencing
		...
		- #### Regulatory Crackdown on Arbitrage
			...
			- **Bank De-Risking**: Financial institutions refuse services to crypto platforms lacking robust compliance
				...
				- Remaining banks (e.g., [[JPMorgan]], [[HSBC]]) conduct extensive due diligence, require proof of licencing, compliance programmes
		...
		- #### Legitimate Multi-Jurisdictional Structures
			- **Regional Entity Strategy**: Separate legal entities per major region
				- **Coinbase Model**:
					...
					- Each entity separately licenced, capitalised, operated
			...
			- **Passporting Rights (EU MiCA)**: Single licence valid across member states
				...
				- **Impact**: Reduces EU licencing costs from €10-20M (27 separate licences) to €2-5M (single MiCA licence)
	  ...
	  collapsed:: true
		...
		- #### Basel Committee on Banking Supervision
			- **Crypto Asset Exposure Standards**: Capital requirements for banks holding crypto
				...
				- Drives banks toward limited crypto exposure, preferring licenced/regulated partners
	  ...
	  collapsed:: true
		- #### Binance - Regulatory Challenges and Transformation
			- **Historical Approach (2017-2021)**: Minimal jurisdictional anchoring
				...
				- Operated globally with limited licencing (Malta registration, later abandoned)
			...
			- **Transformation (2021-2024)**:
				...
				- Regional Restrictions: Blocked customers from high-risk or non-licenced jurisdictions
		...
		- #### Circle - Multi-Jurisdictional Stablecoin Issuer
			...
			- **Regulatory Strategy**:
				...
				- Partner with licenced platforms for distribution (e.g., [[Coinbase]], [[Binance]])
		...
		- #### Kraken - Selective Market Entry
			...
			- **Regional Entities**:
				...
				- Payward Asia Pte Ltd (MAS-licenced, 2023)
			- **Compliance Approach**:
	  ...
	  collapsed:: true
		- #### Regional Harmonisation
			- **EU MiCA**: Most advanced harmonisation effort
				- Single licencing framework replacing 27 national regimes
	  ...
	  collapsed:: true
		- #### Strategic Planning
			- **Market Prioritisation**: Focus on high-value, manageable jurisdictions
				- Analyse market size, regulatory clarity, licencing costs, competitive landscape
		...
		- #### Regulatory Relationship Management
			- **Proactive Engagement**: Build regulator trust before issues arise
				- Regular cheque-ins with supervisory teams
	...
	- ### Related Concepts
		...
		- [[BC-0488-licencing-requirements]] - Multi-jurisdictional licencing
