...
Ontology(<http://narrativegoldmine.com/blockchain/BC-0495>
  ...
  SubClassOf(:VotingSystems :GovernanceApplication)
  ...
  SubClassOf(:VotingSystems
    (ObjectSomeValuesFrom dt:relatedto :DAOGovernance))
  SubClassOf(:VotingSystems
