- ### OntologyBlock
  ...
  collapsed:: true
	...
	- owl:equivalentClass:: bc:Cryptocurrency
	...
	- #### Relationships
	  id:: cryptocurrency-relationships
		...
		- is-part-of:: [[Digital Currency System]], [[Decentralized Network]], [[Money]]
	...
	- #### OWL Axioms
	  ...
	  collapsed:: true
		- ```clojure
		  Declaration(Class(bc:Cryptocurrency))

		  # Classification along two primary dimensions
		  SubClassOf(bc:Cryptocurrency mv:VirtualEntity)
		  SubClassOf(bc:Cryptocurrency mv:Object)

		  # Cryptocurrency operates on blockchain
		  SubClassOf(bc:Cryptocurrency
		    ObjectSomeValuesFrom(mv:hasPart bc:Blockchain)
		  )
		  ...
		  DisjointClasses(mv:NativeCryptocurrency bc:TokenBasedCryptocurrency)
  ...
  id:: cryptocurrency-about
	...
	- ### Technical Components
	  id:: cryptocurrency-components
		...
		- [[Block Explorer]] - Interface for querying and visualising blockchain data
