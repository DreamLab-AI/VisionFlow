...
const defaultSettings: GraphSettings = {
  ...
  edgeWidth: 2.0,
  hierarchyDepth: 0,
  linkDistance: 300,  // Large distance for spacious layout
  chargeStrength: -5000,  // Strong repulsion to prevent clustering
  gravity: 0.005,  // Very weak center pull
  friction: 0.4,  // Low friction for smooth movement
  maxFPS: 60,
  lodEnabled: true,
  highContrast: false,
  reducedMotion: false
