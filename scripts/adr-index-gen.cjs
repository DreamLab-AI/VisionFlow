...
/*
 * adr-index-gen.cjs — walk an ADR docs tree, parse YAML frontmatter, validate,
 * and (re)generate a README.md index table from the frontmatter.
 *
 * Usage:  node scripts/adr-index-gen.cjs <dir> [--check]
 *
...
function main() {
  ...
  if (!dir) { fail('usage: adr-index-gen.cjs <dir> [--check]'); process.exit(2); }
  ...
  let md = '<!-- GENERATED BY scripts/adr-index-gen.cjs — DO NOT EDIT BY HAND (edit PREAMBLE.md for the prose) -->\n\n';
  ...
  md += `_${rows.length} record(s). Regenerate with_ \`node scripts/adr-index-gen.cjs ${dir}\`.\n\n`;
