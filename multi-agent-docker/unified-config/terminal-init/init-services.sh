...
echo "  \033[0;36msudo supervisorctl status\033[0m         - Check all services"
echo "  \033[0;36msudo supervisorctl tail -f <name>\033[0m - View service logs"
echo "  \033[0;36msudo supervisorctl restart <name>\033[0m - Restart service"
...
sudo supervisorctl status | head -10
echo ""
exec zsh
