...
/// Simplified build script for unified GPU kernel compilation and TypeScript generation
fn main() {
    // TypeScript types generation with specta integration
    generate_typescript_types();
    
    // Continue with existing GPU compilation logic
...
fn generate_typescript_types() {
    ...
    let output_dir = "client/src/types/generated";
    if let Err(e) = fs::create_dir_all(output_dir) {
        println!("cargo:warning=Failed to create output directory {}: {}", output_dir, e);
        return;
    }
    
    let output_file = format!("{}/settings.ts", output_dir);
    
    // For now, write a placeholder - full specta integration will be added next
    let placeholder_content = r#"// Generated TypeScript types from Rust
// This file is auto-generated by build.rs
// DO NOT EDIT MANUALLY

export interface AppFullSettings {
  // Types will be generated here once specta integration is complete
  visualisation: any;
  system: any;
  xr: any;
  auth: any;
...
"#;
    ...
    match fs::write(&output_file, placeholder_content) {
        Ok(_) => println!("cargo:warning=Generated TypeScript types at {}", output_file),
        Err(e) => println!("cargo:warning=Failed to write TypeScript types: {}", e),
    }
    
    // Mark for rebuild when config changes
