...
\input{chapters/12a-four-surfaces}

\part{VisionFlow: A Living Experiment}
\label{part:visionflow}

\input{chapters/13-visionflow-canon}
\input{chapters/13b-forum-governance}
\input{chapters/13-technical-substrate}
\input{chapters/13c-agentbox}
\input{chapters/13d-solid-pod}
\input{chapters/13e-ontology-binding}
\input{chapters/13f-dreamlab-edge}

\part{An Honest Assessment}
\label{part:assessment}

\input{chapters/14b-gap-register}
\input{chapters/14c-2022-wager}
\input{chapters/15-open-questions}

\part{Next Steps}
\label{part:next-steps}

\input{chapters/14a-ecosystem-roadmap}
