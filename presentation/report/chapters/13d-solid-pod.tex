...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\textwidth]{diag-solidpod-arch.png}
\caption{solid-pod-rs architecture overview, rendered from the repository's maintained mermaid sources.}
