...
\caption{The wager as printed: the 2022 book's layered stack --- network and Tor at the base, Bitcoin and Nostr as the identity and value layer, spatial engines above them, machine agents and webs of trust, and the human interface at the apex \parencite{OHare2022Convergence}. Four years on, the ecosystem this book audits runs on the second layer and is still building the third and fourth.}
