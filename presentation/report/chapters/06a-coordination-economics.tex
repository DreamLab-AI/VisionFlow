...
The first of those rules now has a falsifiable backing: AgentBox fronts four model families and ships a model-diversity verifier whose sovereign test fails when verification could collapse onto a single family, making engineered diversity a checkable property of the runtime even though routing does not yet force the independent path on every review (Chapter~\ref{ch:agentbox}).
