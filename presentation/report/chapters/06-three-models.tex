...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\textwidth]{02-three-models-comparison.pdf}
\caption{The three models compared: Block's Intelligence Layer, Every's Agent Colony, and DreamLab's Dynamic Agentic Mesh, positioned by how much human coordination each retains.}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\textwidth]{diag-three-layer-mesh.png}
\caption{DreamLab's Dynamic Agentic Mesh: Discovery Engine, Orchestration Layer, and Declarative Governance, with human judgment retained at the intersection points.}
