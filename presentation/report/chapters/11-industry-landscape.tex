...
The labour market told a split-screen story. Displacement was visible and concentrated in tech and finance \parencite{Challenger2026}; entry-level hiring in AI-exposed occupations declined \parencite{Brynjolfsson2025Canaries}. At the same time, high-intensity AI adopters grew headcount rather than shrinking it \parencite{RampRevelio2026, Levie2026} --- the latter a CEO-reported survey without published methodology. Chapter~\ref{ch:collapse-point} holds both halves of that story together, because the report's argument requires it: the distribution of outcomes is an organisational choice, not a technological verdict.
