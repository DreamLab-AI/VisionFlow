...
The most detailed survey-based data on individual AI use comes from Epoch AI's probability-based survey of 2,021 U.S.\ adults conducted via Ipsos KnowledgePanel in March 2026, with a subsample of 665 employed past-week AI users weighted to census benchmarks \parencite{EpochAI2026}.
...
\section{The Split-Screen Labour Market}
\label{sec:split-screen}

The coordination collapse described in this chapter is not only a story about workflows quietly re-arranging themselves inside firms whose headcount stays flat. By July 2026 a genuine labour-market signal has emerged, and it does not tell one story. Read one set of studies and AI is visibly displacing junior workers. Read another set, published in the same weeks, and firms that adopt AI intensively are hiring more people, not fewer. Both are true simultaneously, and the report treats this as a split screen rather than a contradiction to be resolved.

\begin{evidencebox}[title={Displacement Side: Where the Decline Is Concentrated}]
\begin{itemize}
  \item High-frequency US payroll data covering millions of workers shows early-career employees (ages 22--25) in AI-exposed occupations experiencing a relative employment decline of approximately 16 per cent since late 2022; for young software developers specifically, the decline is nearly 20 per cent \parencite{Brynjolfsson2025Canaries}.
  \item 2026 payroll data shows the technology and finance sectors losing approximately 28,000 jobs per month on average, against the wider economy adding approximately 113,000 jobs per month over the same period \parencite{Challenger2026}. Andy Challenger, Senior Vice-President at Challenger, Gray \& Christmas (which has tracked more than 100,000 job-cut announcements in 2026, with AI cited as a factor for four consecutive months) says AI is ``making an impact in a way that no technology has before.''
  \item Not everyone reads the cuts the same way. Pooja Sriram, Vice-President and US Economist at Barclays, offers a counter-reading: ``the narrative that keeps coming up is really a cost-cutting exercise by a lot of firms given the amount of investments they have committed towards AI''. AI, on this account, is as much a cover story for correcting 2022-era over-hiring as it is a direct substitute for labour.
\end{itemize}
\end{evidencebox}

\begin{evidencebox}[title={Expansion Side: Where Adopters Are Hiring More}]
\begin{itemize}
  \item A correlational study of 21,559 US firms, matching high-intensity AI adopters against like-for-like controls, found that high-intensity adopters grew headcount by 10.2 per cent over two years, with entry-level headcount growing faster still, at 12 per cent; the gains did not appear immediately but began 6--12 months after adoption started \parencite{RampRevelio2026}. The study's lead economist, Ara Kharazian, states the caveat himself: ``you should be skeptical. Companies that adopt AI are already faster growing. We control for that by comparing early adopters against firms who haven't adopted yet.''
  \item Box's CEO reports that, of more than 1,600 mid- and large-sized companies surveyed, 58 per cent expect headcount to rise over the next three years, rising to 79 per cent among the most mature AI adopters \parencite{Levie2026}. No published methodology accompanies these figures; they should be read as one CEO's account of his customer base rather than a peer-reviewed study.
\end{itemize}
\end{evidencebox}

Beneath both readings sits a distinction neither side of the argument can afford to ignore: a task is not a job. OpenAI's chief economist, Aaron ``Ronnie'' Chatterji, speaking at the European Central Bank's Forum on Central Banking in Sintra in June 2026, argued (in terms reported rather than quoted verbatim) that a task being exposed to AI does not mean that task will be substituted, and that software development, the profession most often cited as being in the firing line, has not shrunk to anything like the extent predicted as AI capability increased \parencite{Chatterji2026}. Anthropic's own labour-market analysis makes the same point with numbers: theoretical exposure reaches as high as 94 per cent in computer and mathematical occupations, yet observed adoption, and observed job loss, remains far below that ceiling \parencite{AnthropicLabor2026}.

\begin{keyinsight}[title={The Split Screen Is a Distribution, Not a Contradiction}]
Displacement is concentrated where AI is deployed as substitution: routine, junior-heavy, cost-centre work a firm chooses to eliminate rather than redirect. Growth is concentrated where AI is deployed for expansion: adopters who redeploy freed capacity toward more customers, more projects, and more ambitious scope hire more people, not fewer, and hire disproportionately at entry level once the capability compounds. Both patterns are visible in the same mid-2026 data because both are genuinely happening, in different firms, at the same time. The organisational choice this report calls the \emph{three models} (Block's intelligence layer, Every's agent colony, and DreamLab's dynamic agentic mesh) is not a neutral description of strategy. It is the mechanism that decides which side of the split screen a given firm lands on.
\end{keyinsight}
...
This is not only a shadow AI problem. On the sanctioned side of the ledger, 95 per cent of generative AI pilots produce no measurable financial impact \parencite{MITNANDA2025}; ungoverned shadow AI and failed official pilots are two faces of the same integration failure: technology deployed without the organisational redesign that would make it usable.
