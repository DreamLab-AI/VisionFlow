...
graph TD
    ...
    subgraph ServerApp[Backend]
        ...
        subgraph Services[Core Services]
            ...
            RAGFlowSvc[RAGFlowService]
            PerplexitySvc[PerplexityService]
        end
        ...
        FileSvc --> MetadataActor
        NostrSvc --> ProtectedSettingsActor
        SpeechSvc --> SettingsActor
        RAGFlowSvc --> SettingsActor
        PerplexitySvc --> SettingsActor
    end
    ...
    FileSvc --> GitHub
    NostrSvc --> NostrRelays
    SpeechSvc --> OpenAI
    SpeechSvc --> Kokoro
    PerplexitySvc --> PerplexityAI
    RAGFlowSvc --> RAGFlow
    ...
    style External fill:#282C34,stroke:#F7DF1E,stroke-width:2px,color:#FFFFFF
