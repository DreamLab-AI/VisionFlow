...
fn test_wire_format_is_26_bytes() {
    ...
    let decoded_pos_x = f32::from_le_bytes([buffer[cursor], buffer[cursor + 1], buffer[cursor + 2], buffer[cursor + 3]]);
    cursor += 4;
    let decoded_pos_y = f32::from_le_bytes([buffer[cursor], buffer[cursor + 1], buffer[cursor + 2], buffer[cursor + 3]]);
    cursor += 4;
    let decoded_pos_z = f32::from_le_bytes([buffer[cursor], buffer[cursor + 1], buffer[cursor + 2], buffer[cursor + 3]]);
    cursor += 4;
    
    let decoded_vel_x = f32::from_le_bytes([buffer[cursor], buffer[cursor + 1], buffer[cursor + 2], buffer[cursor + 3]]);
    cursor += 4;
    let decoded_vel_y = f32::from_le_bytes([buffer[cursor], buffer[cursor + 1], buffer[cursor + 2], buffer[cursor + 3]]);
    cursor += 4;
    let decoded_vel_z = f32::from_le_bytes([buffer[cursor], buffer[cursor + 1], buffer[cursor + 2], buffer[cursor + 3]]);
